...
struct UMediaPlateComponent : UActorComponent {
	...
	void Stop(); // Function MediaPlate.MediaPlateComponent.Stop // (Final|Native|Public|BlueprintCallable) // @ game+0x7392210
	void Play(); // Function MediaPlate.MediaPlateComponent.Play // (Final|Native|Public|BlueprintCallable) // @ game+0x73921fc
	struct UMediaTexture* GetMediaTexture(); // Function MediaPlate.MediaPlateComponent.GetMediaTexture // (Final|Native|Public|BlueprintCallable) // @ game+0x73921dc
	struct UMediaPlayer* GetMediaPlayer(); // Function MediaPlate.MediaPlateComponent.GetMediaPlayer // (Final|Native|Public|BlueprintCallable) // @ game+0x73921bc
};
