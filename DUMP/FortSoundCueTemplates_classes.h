...
struct UFortSoundCueTemplateDefaultSettings : UDataAsset {
	...
	struct UFortSoundCueTemplateDefaults* GetSettingsForTemplateType(struct UFortSoundCueTemplateBase* TemplateType); // Function FortSoundCueTemplates.FortSoundCueTemplateDefaultSettings.GetSettingsForTemplateType // (Final|Native|Public) // @ game+0x70b9148
};
...
struct UFortSoundCueTemplateSettings : UDeveloperSettings {
	...
	struct UFortSoundCueTemplateDefaults* GetDefaultSettingsForTemplateType(struct UFortSoundCueTemplateBase* TemplateType); // Function FortSoundCueTemplates.FortSoundCueTemplateSettings.GetDefaultSettingsForTemplateType // (Final|Native|Public|Const) // @ game+0x70b90b8
};
