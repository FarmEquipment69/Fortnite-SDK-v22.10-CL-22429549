...
struct UVoiceChatMemberListEntry_C : UFortVoiceChatMemberListEntry {
	...
	void BP_OnUnhovered(); // Function VoiceChatMemberListEntry.VoiceChatMemberListEntry_C.BP_OnUnhovered // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	...
	void BP_OnHovered(); // Function VoiceChatMemberListEntry.VoiceChatMemberListEntry_C.BP_OnHovered // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void ExecuteUbergraph_VoiceChatMemberListEntry(int32_t EntryPoint); // Function VoiceChatMemberListEntry.VoiceChatMemberListEntry_C.ExecuteUbergraph_VoiceChatMemberListEntry // (Final|UbergraphFunction) // @ game+0xda071c
};
