...
struct ADynamicUIDirectorBase : AActor {
	...
	void RemoveScene(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIDirectorBase.RemoveScene // (Final|Native|Public|BlueprintCallable) // @ game+0x63ed8d8
	struct APlayerController* GetOwningLocalPlayerController(); // Function DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayerController // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x63ed8b4
	struct ULocalPlayer* GetOwningLocalPlayer(); // Function DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x63ed848
	void AddScene(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIDirectorBase.AddScene // (Final|Native|Public|BlueprintCallable) // @ game+0x237b734
};
...
struct UDynamicUIManager : UWorldSubsystem {
	...
	void RemoveScenes(struct TArray<struct UDynamicUIScene*> Scenes, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.RemoveScenes // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ee050
	void RemoveSceneFromFirstLocalPlayer(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIManager.RemoveSceneFromFirstLocalPlayer // (Final|Native|Protected|BlueprintCallable) // @ game+0x63edcf4
	void RemoveScene(struct UDynamicUIScene* Scene, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.RemoveScene // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ed958
	void AddSceneToFirstLocalPlayer(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIManager.AddSceneToFirstLocalPlayer // (Final|Native|Protected|BlueprintCallable) // @ game+0x63ed39c
	void AddScenes(struct TArray<struct UDynamicUIScene*> Scenes, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.AddScenes // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ed704
	void AddScene(struct UDynamicUIScene* Scene, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.AddScene // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ecff4
};
...
struct UDynamicUITransitionableWidgetInterface : UInterface {
	...
	void BroadcastTransitionCompleted(); // Function DynamicUI.DynamicUITransitionableWidgetInterface.BroadcastTransitionCompleted // (Native|Protected|BlueprintCallable) // @ game+0x63ed834
};
