...
struct UDownloadOnDemandAddProjectModal : UCommonActivatableWidget {
	...
	void UpdateLightningViolator(enum class ESlateVisibility InVisibility, struct FText& InText); // Function VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.UpdateLightningViolator // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void HandleDownloadLinkCodeTextChanged(struct FText& InMnemonic); // Function VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkCodeTextChanged // (Final|Native|Private|HasOutParms) // @ game+0x6bf3e50
};
...
struct UDownloadOnDemandProjectManagementTab : UUserWidget {
	...
	void UpdateProjectConfirmed(); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.UpdateProjectConfirmed // (Final|Native|Protected|BlueprintCallable) // @ game+0x6bf3fb8
	void RemoveProjectConfirmed(); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed // (Final|Native|Protected|BlueprintCallable) // @ game+0x6bf3f14
};
...
struct UDownloadOnDemandProjectTile : UCommonButtonLegacy {
	...
	void UpdateLabel(bool bShowLabel); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectTile.UpdateLabel // (Final|Native|Public|BlueprintCallable) // @ game+0x6bf3f38
	void OnLabelUpdated(); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectTile.OnLabelUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
