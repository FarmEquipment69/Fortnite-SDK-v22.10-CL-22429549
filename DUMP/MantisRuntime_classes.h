...
struct UFortGameplayAbility_Mantis : UFortGameplayAbility {
	...
	void OnMontageFinished(); // Function MantisRuntime.FortGameplayAbility_Mantis.OnMontageFinished // (Final|Native|Protected) // @ game+0x658e5f4
	void OnMontageCancelled(); // Function MantisRuntime.FortGameplayAbility_Mantis.OnMontageCancelled // (Final|Native|Protected) // @ game+0x658e5a0
	void ConfigureRootMotionWarping(struct AActor*& OutTargetActor, bool& bOutAllowTranslationWarp, bool& bOutAllowRotationWarp, bool& bOutSnapshotTargetLocation); // Function MantisRuntime.FortGameplayAbility_Mantis.ConfigureRootMotionWarping // (Native|Event|Protected|HasOutParms|BlueprintEvent) // @ game+0x658e29c
	void BP_OnMantisTechniqueHit(struct FGameplayAbilityTargetDataHandle& TargetDataHandle, struct FGameplayTag ApplicationTag); // Function MantisRuntime.FortGameplayAbility_Mantis.BP_OnMantisTechniqueHit // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void BP_MantisAbilityTechniqueStarted(struct FGameplayTagContainer OwningTags, struct FName SequenceName, bool StartsSequence, bool EndsSequence); // Function MantisRuntime.FortGameplayAbility_Mantis.BP_MantisAbilityTechniqueStarted // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortMantisPawnComponent : UPawnComponent {
	...
	void SetLockOnState(bool bEnabled, struct AActor* TargetActor); // Function MantisRuntime.FortMantisPawnComponent.SetLockOnState // (Final|Native|Public|BlueprintCallable) // @ game+0x658e6e4
	void OnPostPhysicsRotation(struct UCharacterMovementComponent* CharMoveComp, float DeltaSeconds); // Function MantisRuntime.FortMantisPawnComponent.OnPostPhysicsRotation // (Final|Native|Protected) // @ game+0x658e61c
	void OnOwnerWeaponHolstered(); // Function MantisRuntime.FortMantisPawnComponent.OnOwnerWeaponHolstered // (Final|Native|Protected) // @ game+0x658e608
	void OnCharacterMovementPreUpdate(struct UCharacterMovementComponent* CharMoveComp, float DeltaSeconds); // Function MantisRuntime.FortMantisPawnComponent.OnCharacterMovementPreUpdate // (Final|Native|Protected) // @ game+0x658e4d8
	bool IsPerformingLockOn(); // Function MantisRuntime.FortMantisPawnComponent.IsPerformingLockOn // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x658e4bc
	bool HasLockOnTarget(); // Function MantisRuntime.FortMantisPawnComponent.HasLockOnTarget // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x658e440
	struct AActor* GetLockOnTarget(); // Function MantisRuntime.FortMantisPawnComponent.GetLockOnTarget // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x658e41c
};
