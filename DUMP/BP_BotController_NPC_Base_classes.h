...
struct ABP_BotController_NPC_Base_C : ABP_PhoebeController_NonParticipant_C {
	...
	void BndEvt__FortAthenaNpcPatrolling_K2Node_ComponentBoundEvent_1_PatrollingComponentOnStopPatrolling__DelegateSignature(); // Function BP_BotController_NPC_Base.BP_BotController_NPC_Base_C.BndEvt__FortAthenaNpcPatrolling_K2Node_ComponentBoundEvent_1_PatrollingComponentOnStopPatrolling__DelegateSignature // (BlueprintEvent) // @ game+0xda071c
	void ExecuteUbergraph_BP_BotController_NPC_Base(int32_t EntryPoint); // Function BP_BotController_NPC_Base.BP_BotController_NPC_Base_C.ExecuteUbergraph_BP_BotController_NPC_Base // (Final|UbergraphFunction|HasDefaults) // @ game+0xda071c
};
