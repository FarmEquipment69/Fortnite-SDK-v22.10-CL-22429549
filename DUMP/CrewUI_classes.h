...
struct UBattlePassCrewPurchaseButton : UFortHoldableButton {
	...
	void OnCurrencyUpdated(); // Function CrewUI.BattlePassCrewPurchaseButton.OnCurrencyUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UBattlePassCrewPurchaseContainer : UCommonActivatableWidget {
	...
	void OnTriggerIntroAnimation(bool bCanClaimRewards); // Function CrewUI.BattlePassCrewPurchaseContainer.OnTriggerIntroAnimation // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnContentStateUpdated(enum class EBattlePassCrewContentState InState, bool bInScreenOpened); // Function CrewUI.BattlePassCrewPurchaseContainer.OnContentStateUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UBattlePassPurchaseScreen : UCMSBackgroundWidget {
	...
	void OnShowNavButtonNotification(bool bShowNotification); // Function CrewUI.BattlePassPurchaseScreen.OnShowNavButtonNotification // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnSetScreenInteractable(bool bInteractable); // Function CrewUI.BattlePassPurchaseScreen.OnSetScreenInteractable // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnSetNavButtonNotificationText(struct FText& NotificationText); // Function CrewUI.BattlePassPurchaseScreen.OnSetNavButtonNotificationText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnPurchaseStateChanged(enum class EBattlePassPurchaseState InCurrentState); // Function CrewUI.BattlePassPurchaseScreen.OnPurchaseStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnPurchaseConfirmed(); // Function CrewUI.BattlePassPurchaseScreen.OnPurchaseConfirmed // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UCrewMultiSubscriptionAlertModal : UCommonActivatableWidget {
	...
	void OnSetHowToCancelURL(struct FString MoreInfoUrl); // Function CrewUI.CrewMultiSubscriptionAlertModal.OnSetHowToCancelURL // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UCrewPriceChangeAcknowledgeModal : UCommonActivatableWidget {
	...
	void OnSetPriceChangeAcknowledgeTitle(struct FText& Title); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeTitle // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeMoreInfoUrl(struct FText& MoreInfoUrl); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoUrl // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeMoreInfoText(struct FText& ConfirmButtonText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeConfirmButtonText(struct FText& ConfirmButtonText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeConfirmButtonText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeCheckboxText(struct FText& CheckboxText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCheckboxText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText(struct FText& CancelSubscriptionButtonText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeBodyText(struct FText& BodyText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnSetPriceChangeAcknowledgeBodyTable(struct TArray<struct FCrewTableRow>& PriceChangeByRegionRows); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyTable // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnModalBackout(); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnModalBackout // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void ExitModal(); // Function CrewUI.CrewPriceChangeAcknowledgeModal.ExitModal // (Final|Native|Protected|BlueprintCallable) // @ game+0x5cb6ca8
};
...
struct UCrewPurchaseScreen : UCMSBackgroundWidget {
	...
	void OnUserInformationTextsUpdated(struct FText& UserInformationText1, struct FText& UserInformationText2, enum class EMcpSubscriptionState SubscriptionState); // Function CrewUI.CrewPurchaseScreen.OnUserInformationTextsUpdated // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnUpdateVBuckRefundVisibility(bool bVisible); // Function CrewUI.CrewPurchaseScreen.OnUpdateVBuckRefundVisibility // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnUpdatePurchaseButtonState(enum class ECrewPurchaseButtonState ButtonState); // Function CrewUI.CrewPurchaseScreen.OnUpdatePurchaseButtonState // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnShowNavButtonNotification(bool bShowNotification); // Function CrewUI.CrewPurchaseScreen.OnShowNavButtonNotification // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnSetNavButtonNotificationText(struct FText& NotificationText); // Function CrewUI.CrewPurchaseScreen.OnSetNavButtonNotificationText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs); // Function CrewUI.CrewPurchaseScreen.OnContainerTabVisibilityUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void EndProgress(); // Function CrewUI.CrewPurchaseScreen.EndProgress // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void BeginProgress(struct FText& ProgressLabel); // Function CrewUI.CrewPurchaseScreen.BeginProgress // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
};
...
struct UCrewRewardTile : UCommonButtonBase {
	...
	void OnUpdateOwnedState(bool bOwned); // Function CrewUI.CrewRewardTile.OnUpdateOwnedState // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnStartingDownloadTileImage(); // Function CrewUI.CrewRewardTile.OnStartingDownloadTileImage // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnDownloadTileImageComplete(struct UTexture2D* Texture); // Function CrewUI.CrewRewardTile.OnDownloadTileImageComplete // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	bool IsMonthlyBenefit(); // Function CrewUI.CrewRewardTile.IsMonthlyBenefit // (Final|Native|Protected|BlueprintCallable|BlueprintPure|Const) // @ game+0x685cbb4
};
...
struct UCrewSubscriptionContentContainer : UCommonActivatableWidget {
	...
	void OnTabSelected(int32_t TabIndex); // Function CrewUI.CrewSubscriptionContentContainer.OnTabSelected // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UCrewTileDetailsTag : UCommonUserWidget {
	...
	void OnTagSetup(enum class ECrewDetailsTag RewardTag, bool bIsOwnedTag); // Function CrewUI.CrewTileDetailsTag.OnTagSetup // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveScreenBase : UFortItemPreviewScreen {
	...
	void BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs); // Function CrewUI.FortProgressiveScreenBase.BP_OnContainerTabVisibilityUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveItemScreen : UFortProgressiveScreenBase {
	...
	void OnUpdateSubscriptionState(bool bSubscribed); // Function CrewUI.FortProgressiveItemScreen.OnUpdateSubscriptionState // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnSetIsSoloScreen(bool bInIsSoloScreen); // Function CrewUI.FortProgressiveItemScreen.OnSetIsSoloScreen // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnItemSelected(); // Function CrewUI.FortProgressiveItemScreen.OnItemSelected // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnErrorStateTextUpdated(struct FText& ErrorStateText); // Function CrewUI.FortProgressiveItemScreen.OnErrorStateTextUpdated // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveItemStateTitleWidget : UUserWidget {
	...
	void BP_OnSetHeaderInfo(struct FText& Subheading, bool bSubscribed, int32_t UnlockedStages, int32_t MaxStages); // Function CrewUI.FortProgressiveItemStateTitleWidget.BP_OnSetHeaderInfo // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveItemWidget : UCommonButtonBase {
	...
	void OnUnhighlighted(); // Function CrewUI.FortProgressiveItemWidget.OnUnhighlighted // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnTileMaterialLoaded(bool bSubscribed); // Function CrewUI.FortProgressiveItemWidget.OnTileMaterialLoaded // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnStageItemChanged(struct FProgressiveStageItemInfo& InStageItemInfo); // Function CrewUI.FortProgressiveItemWidget.OnStageItemChanged // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnPeekStateChanged(bool bIsInPeekState); // Function CrewUI.FortProgressiveItemWidget.OnPeekStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnHighlighted(); // Function CrewUI.FortProgressiveItemWidget.OnHighlighted // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveSetDetailsWidget : UUserWidget {
	...
	void BP_OnUpdateSetDetails(struct FText& SetName, struct FText& ExpiringText, bool bCompleted); // Function CrewUI.FortProgressiveSetDetailsWidget.BP_OnUpdateSetDetails // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveSetList : UCommonActivatableWidget {
	...
	void ClearSetTiles(); // Function CrewUI.FortProgressiveSetList.ClearSetTiles // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	struct UFortProgressiveSetTile* AddSetTile(); // Function CrewUI.FortProgressiveSetList.AddSetTile // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveSetTile : UCommonButtonBase {
	...
	void BP_OnTileMaterialLoaded(bool bSubscribed); // Function CrewUI.FortProgressiveSetTile.BP_OnTileMaterialLoaded // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void BP_OnInitializeSetInfo(struct FProgressiveSetInfo& InSetInfo, struct FText& BottomText, struct FText& BottomSubtext, bool bSubscribed); // Function CrewUI.FortProgressiveSetTile.BP_OnInitializeSetInfo // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveStageList : UCommonActivatableWidget {
	...
	void SelectStageInDirection(int32_t Direction); // Function CrewUI.FortProgressiveStageList.SelectStageInDirection // (Final|Native|Public|BlueprintCallable) // @ game+0x68704f8
	void ClearStageWidgets(); // Function CrewUI.FortProgressiveStageList.ClearStageWidgets // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	struct UFortProgressiveStageWidget* AddStageWidget(); // Function CrewUI.FortProgressiveStageList.AddStageWidget // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveStageWidget : UCommonUserWidget {
	...
	void OnSetTooltipVisible(bool bVisible); // Function CrewUI.FortProgressiveStageWidget.OnSetTooltipVisible // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnSetTooltipText(struct FText& InToolTipText); // Function CrewUI.FortProgressiveStageWidget.OnSetTooltipText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnPeekStateChanged(bool bIsInPeekState); // Function CrewUI.FortProgressiveStageWidget.OnPeekStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void ClearStageItemWidgets(); // Function CrewUI.FortProgressiveStageWidget.ClearStageItemWidgets // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	struct UFortProgressiveItemWidget* AddStageItemWidget(); // Function CrewUI.FortProgressiveStageWidget.AddStageItemWidget // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortProgressiveTableOfContentsScreen : UFortProgressiveScreenBase {
	...
	void BP_OnUpdateSubscriptionState(bool bSubscribed); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateSubscriptionState // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void BP_OnUpdateNumTilesAvailable(int32_t NumTiles); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateNumTilesAvailable // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void BP_OnUpdateErrorStateText(struct FText& ErrorStateText); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateErrorStateText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void BP_OnUpdateBanner(struct FText& BannerText, bool bAllSetsCompleted, bool bSubscribed); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateBanner // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void BP_OnSetDescriptionText(struct FText& ProductDescription); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnSetDescriptionText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda071c
};
