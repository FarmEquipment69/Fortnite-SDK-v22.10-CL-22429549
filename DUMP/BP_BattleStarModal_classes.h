...
struct UBP_BattleStarModal_C : UFortBattlePassPurchaseResourcesWidget {
	...
	void Randomize stars hovering(); // Function BP_BattleStarModal.BP_BattleStarModal_C.Randomize stars hovering // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void OnPurchaseAmountChanged(int32_t NewAmount, int32_t LevelsLeft); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnPurchaseAmountChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnTotalPriceChanged(int32_t NewPrice); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnTotalPriceChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void BP_OnActivated(); // Function BP_BattleStarModal.BP_BattleStarModal_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnOfferUnavailable(); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnOfferUnavailable // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void Construct(); // Function BP_BattleStarModal.BP_BattleStarModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda071c
	void PreConstruct(bool IsDesignTime); // Function BP_BattleStarModal.BP_BattleStarModal_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda071c
	void Update Disclaimer(); // Function BP_BattleStarModal.BP_BattleStarModal_C.Update Disclaimer // (BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void UpdatePageUnlockText(int32_t LevelsPurchase); // Function BP_BattleStarModal.BP_BattleStarModal_C.UpdatePageUnlockText // (BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void OnAmountChangeButtonClicked(); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnAmountChangeButtonClicked // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void HoldActionProgress(bool IsHolding); // Function BP_BattleStarModal.BP_BattleStarModal_C.HoldActionProgress // (BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void ExecuteUbergraph_BP_BattleStarModal(int32_t EntryPoint); // Function BP_BattleStarModal.BP_BattleStarModal_C.ExecuteUbergraph_BP_BattleStarModal // (Final|UbergraphFunction|HasDefaults) // @ game+0xda071c
};
