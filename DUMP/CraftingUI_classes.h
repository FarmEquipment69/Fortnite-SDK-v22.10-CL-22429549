...
struct UAthenaCraftingQuickBarButton : UAthenaQuickBarSlotButtonBase {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaCraftingQuickBarButton.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaCraftingQuickBarButton.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UAthenaEquippedItemCraftingIndicator : UCommonUserWidget {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaEquippedItemCraftingIndicator.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaEquippedItemCraftingIndicator.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void HandleWeaponEquipped(struct AFortWeapon* NewWeapon, struct AFortWeapon* PrevWeapon); // Function CraftingUI.AthenaEquippedItemCraftingIndicator.HandleWeaponEquipped // (Final|Native|Private) // @ game+0x67cc314
};
...
struct UAthenaInventoryItemInfoCraftingIndicator : UCommonUserWidget {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaInventoryItemInfoCraftingIndicator.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaInventoryItemInfoCraftingIndicator.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void HandleInventoryItemSelected(struct UFortItem* SelectedItem); // Function CraftingUI.AthenaInventoryItemInfoCraftingIndicator.HandleInventoryItemSelected // (Final|Native|Private) // @ game+0x67cc214
};
...
struct UAthenaQuickBarSlotCraftingIndicator : UAthenaQuickBarSlotExtensionWidgetBase {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnIngredientChanged(bool bCanCraftNow); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.OnIngredientChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void HandleWeaponEquipped(struct AFortWeapon* NewWeapon, struct AFortWeapon* PrevWeapon); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.HandleWeaponEquipped // (Final|Native|Private) // @ game+0x67cc3d8
};
...
struct UFortCraftingIngredientWidget : UCommonUserWidget {
	...
	void OnIngredientWidgetUpdated(int32_t NumAvailable, int32_t NumRequired, bool bIsPrimaryIngredient, bool bIsLastIngredient); // Function CraftingUI.FortCraftingIngredientWidget.OnIngredientWidgetUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortCraftingItemInfoWidget : UCommonActivatableWidget {
	...
	void OnItemRaritySet(enum class EFortRarity Rarity, struct FFortRarityItemData RarityItemData); // Function CraftingUI.FortCraftingItemInfoWidget.OnItemRaritySet // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortCraftingListEntry : UCommonButtonLegacy {
	...
	void OnCraftingListItemSet(); // Function CraftingUI.FortCraftingListEntry.OnCraftingListItemSet // (Event|Protected|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortCraftingTab : UCommonActivatableWidget {
	...
	void OnFormulaListUpdated(int32_t NumFormulas); // Function CraftingUI.FortCraftingTab.OnFormulaListUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void HandleInventoryItemSelected(struct UFortItem* Item); // Function CraftingUI.FortCraftingTab.HandleInventoryItemSelected // (Final|Native|Private) // @ game+0x67cc294
};
...
struct UFortPotContentsPopup : UUserWidget {
	...
	void SetOwningCraftingObject(struct ACraftingObjectBGA* InCraftingObject); // Function CraftingUI.FortPotContentsPopup.SetOwningCraftingObject // (Final|Native|Public|BlueprintCallable) // @ game+0x67cc494
};
