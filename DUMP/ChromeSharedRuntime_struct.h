...
struct FLacklusterData {
	...
	struct TArray<struct FString> MaterialsToIgnore; // 0x28(0x10)
	struct TMap<enum class ELacklusterTextureGroup, struct FName> SetParameterNames; // 0x38(0x50)
	struct TArray<struct FClassToActorType> ClassesToActorTypes; // 0x88(0x10)
	struct TMap<enum class ELacklusterActorType, struct FChromeTypeToMaterial> ChromeMaterialOverrides; // 0x98(0x50)
	struct TMap<enum class ELacklusterActorType, struct FChromeTextureSetArray> ActorToTextures; // 0xe8(0x50)
	struct TArray<struct FTagQueryToChromeTypeOverride> TagQueryToChromeTypeOverrides; // 0x138(0x10)
	struct TMap<struct FName, enum class ELacklusterActorType> TagToActorTypes; // 0x148(0x50)
	struct UMaterialInstance* GenericChromeMaterial; // 0x198(0x08)
	struct FGameplayTagContainer NoAnimChestMaterialTags; // 0x1a0(0x20)
	struct UMaterialInstance* ChromeAnimChestMaterial; // 0x1c0(0x08)
	struct UMaterialInstance* ChromeNoAnimChestMaterial; // 0x1c8(0x08)
	bool bIsInitialized; // 0x1d0(0x01)
