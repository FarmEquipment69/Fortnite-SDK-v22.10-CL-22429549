...
struct FAthenaShopSpecialOffer {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct FVideoWidgetConfig SpecialOfferVideo; // 0x08(0x80)
};
...
struct FVideoWidgetConfig {
	...
	bool bFadeFromWhite; // 0x2b(0x01)
	bool bEndFadeFromWhite; // 0x2c(0x01)
	bool bFadeUpToWhite; // 0x2d(0x01)
	...
	bool bTreatAudioOnlyAsWhiteFades; // 0x7c(0x01)
...
struct FMatchmakingUIOverride {
	...
	struct TSoftClassPtr<UObject> SoftLobbyMatchmakingWidgetClass; // 0x28(0x28)
};
