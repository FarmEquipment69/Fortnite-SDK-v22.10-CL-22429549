...
struct FNevadaInPersistent : FFortVehicleInPersistent {
	struct UFortNevadaVehicleConfigs* FortNevadaVehicleConfigs; // 0x170(0x08)
	bool bBoostThrust; // 0x178(0x01)
	bool bBoostDrag; // 0x179(0x01)
	char pad_17A[0x2]; // 0x17a(0x02)
	float TractorBeamExtraLengthForExtents; // 0x17c(0x04)
	bool bUseTractorBeamUprightForce; // 0x180(0x01)
	char pad_181[0x7]; // 0x181(0x07)
	struct FVector CrashingDesiredUp; // 0x188(0x18)
	enum class ENevadaFlightStates CurrentVehicleState; // 0x1a0(0x01)
	char pad_1A1[0xdf]; // 0x1a1(0xdf)
};
