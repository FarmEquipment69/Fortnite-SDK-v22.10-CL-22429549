...
struct FDagwoodInPersistent : FFortVehicleInPersistent {
	struct UFortDagwoodVehicleConfigs* FortDagwoodVehicleConfigs; // 0x170(0x08)
	struct FDagwoodRuntimeModifiers DagwoodRuntimeModifiedProperties; // 0x178(0x70)
	struct TArray<enum class ETireStates> TireStates; // 0x1e8(0x10)
