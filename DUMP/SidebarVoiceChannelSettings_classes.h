...
struct USidebarVoiceChannelSettings_C : UFortVoiceSettingsDisplay {
	...
	void ExecuteUbergraph_SidebarVoiceChannelSettings(int32_t EntryPoint); // Function SidebarVoiceChannelSettings.SidebarVoiceChannelSettings_C.ExecuteUbergraph_SidebarVoiceChannelSettings // (Final|UbergraphFunction) // @ game+0xda071c
};
