...
// ScriptStruct ControlRig.RigUnit_SetAnimAttributeBase
// Size: 0x38 (Inherited: 0x38)
struct FRigUnit_SetAnimAttributeBase : FRigUnitMutable {
};

// ScriptStruct ControlRig.RigUnit_SetAnimAttribute_Integer
// Size: 0x50 (Inherited: 0x38)
struct FRigUnit_SetAnimAttribute_Integer : FRigUnit_SetAnimAttributeBase {
	struct FName Name; // 0x38(0x04)
	struct FName BoneName; // 0x3c(0x04)
	int32_t Value; // 0x40(0x04)
	struct FName CachedBoneName; // 0x44(0x04)
	int32_t CachedBoneIndex; // 0x48(0x04)
	char pad_4C[0x4]; // 0x4c(0x04)
};

// ScriptStruct ControlRig.RigUnit_SetAnimAttribute_Float
// Size: 0x50 (Inherited: 0x38)
struct FRigUnit_SetAnimAttribute_Float : FRigUnit_SetAnimAttributeBase {
	struct FName Name; // 0x38(0x04)
	struct FName BoneName; // 0x3c(0x04)
...
// ScriptStruct ControlRig.RigUnit_SetAnimAttribute_Transform
// Size: 0xb0 (Inherited: 0x38)
struct FRigUnit_SetAnimAttribute_Transform : FRigUnit_SetAnimAttributeBase {
	struct FName Name; // 0x38(0x04)
	struct FName BoneName; // 0x3c(0x04)
	struct FTransform Value; // 0x40(0x60)
	struct FName CachedBoneName; // 0xa0(0x04)
	int32_t CachedBoneIndex; // 0xa4(0x04)
	char pad_A8[0x8]; // 0xa8(0x08)
};

// ScriptStruct ControlRig.RigUnit_SetAnimAttribute_Vector
// Size: 0x60 (Inherited: 0x38)
struct FRigUnit_SetAnimAttribute_Vector : FRigUnit_SetAnimAttributeBase {
	struct FName Name; // 0x38(0x04)
	struct FName BoneName; // 0x3c(0x04)
	struct FVector Value; // 0x40(0x18)
	struct FName CachedBoneName; // 0x58(0x04)
	int32_t CachedBoneIndex; // 0x5c(0x04)
};

// ScriptStruct ControlRig.RigUnit_SetAnimAttribute_Quaternion
// Size: 0x70 (Inherited: 0x38)
struct FRigUnit_SetAnimAttribute_Quaternion : FRigUnit_SetAnimAttributeBase {
	struct FName Name; // 0x38(0x04)
	struct FName BoneName; // 0x3c(0x04)
	struct FQuat Value; // 0x40(0x20)
	struct FName CachedBoneName; // 0x60(0x04)
	int32_t CachedBoneIndex; // 0x64(0x04)
	char pad_68[0x8]; // 0x68(0x08)
};

// ScriptStruct ControlRig.RigUnit_GetAnimAttributeBase
// Size: 0x08 (Inherited: 0x08)
struct FRigUnit_GetAnimAttributeBase : FRigUnit {
};

// ScriptStruct ControlRig.RigUnit_GetAnimAttribute_Integer
// Size: 0x28 (Inherited: 0x08)
struct FRigUnit_GetAnimAttribute_Integer : FRigUnit_GetAnimAttributeBase {
	struct FName Name; // 0x08(0x04)
	struct FName BoneName; // 0x0c(0x04)
	int32_t FallbackValue; // 0x10(0x04)
	int32_t Value; // 0x14(0x04)
	bool bWasFound; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	struct FName CachedBoneName; // 0x1c(0x04)
	int32_t CachedBoneIndex; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
};

// ScriptStruct ControlRig.RigUnit_GetAnimAttribute_Float
// Size: 0x28 (Inherited: 0x08)
struct FRigUnit_GetAnimAttribute_Float : FRigUnit_GetAnimAttributeBase {
	struct FName Name; // 0x08(0x04)
	struct FName BoneName; // 0x0c(0x04)
...
// ScriptStruct ControlRig.RigUnit_GetAnimAttribute_Transform
// Size: 0xe0 (Inherited: 0x08)
struct FRigUnit_GetAnimAttribute_Transform : FRigUnit_GetAnimAttributeBase {
	struct FName Name; // 0x08(0x04)
	struct FName BoneName; // 0x0c(0x04)
	struct FTransform FallbackValue; // 0x10(0x60)
	struct FTransform Value; // 0x70(0x60)
	bool bWasFound; // 0xd0(0x01)
	char pad_D1[0x3]; // 0xd1(0x03)
	struct FName CachedBoneName; // 0xd4(0x04)
	int32_t CachedBoneIndex; // 0xd8(0x04)
	char pad_DC[0x4]; // 0xdc(0x04)
};

// ScriptStruct ControlRig.RigUnit_GetAnimAttribute_Vector
// Size: 0x50 (Inherited: 0x08)
struct FRigUnit_GetAnimAttribute_Vector : FRigUnit_GetAnimAttributeBase {
	struct FName Name; // 0x08(0x04)
	struct FName BoneName; // 0x0c(0x04)
	struct FVector FallbackValue; // 0x10(0x18)
	struct FVector Value; // 0x28(0x18)
	bool bWasFound; // 0x40(0x01)
...
// ScriptStruct ControlRig.RigUnit_GetAnimAttribute_Quaternion
// Size: 0x60 (Inherited: 0x08)
struct FRigUnit_GetAnimAttribute_Quaternion : FRigUnit_GetAnimAttributeBase {
	struct FName Name; // 0x08(0x04)
	struct FName BoneName; // 0x0c(0x04)
	struct FQuat FallbackValue; // 0x10(0x20)
	struct FQuat Value; // 0x30(0x20)
	bool bWasFound; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
	struct FName CachedBoneName; // 0x54(0x04)
	int32_t CachedBoneIndex; // 0x58(0x04)
