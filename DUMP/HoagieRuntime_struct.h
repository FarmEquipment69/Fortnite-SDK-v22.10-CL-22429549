...
struct FHoagieInPersistent : FFortVehicleInPersistent {
	struct UFortHoagieVehicleConfigs* FortHoagieVehicleConfigs; // 0x170(0x08)
	enum class EHoagieState CurrentHoagieState; // 0x178(0x04)
	float LastRotorImpulseTime; // 0x17c(0x04)
	struct FVector RotorHitLinearImpulse; // 0x180(0x18)
	struct FVector RotorHitAngularImpulse; // 0x198(0x18)
};
