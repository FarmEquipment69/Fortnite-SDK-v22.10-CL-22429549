...
struct UFortStoreSelectionOptionEntry : UCommonButtonLegacy {
	struct UFortLazyImage* Image_Icon; // 0x1070(0x08)
	struct UCommonTextBlock* Text_Description; // 0x1078(0x08)
	struct UCommonTextBlock* Text_Price; // 0x1080(0x08)
	struct UCommonRichTextBlock* RichText_Label; // 0x1088(0x08)
};
