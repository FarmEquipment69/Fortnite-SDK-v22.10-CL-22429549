...
struct USidebarVoiceChatMemberListEntry_C : UFortVoiceChatMemberListEntry {
	...
	void BP_OnUnhovered(); // Function SidebarVoiceChatMemberListEntry.SidebarVoiceChatMemberListEntry_C.BP_OnUnhovered // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	...
	void BP_OnHovered(); // Function SidebarVoiceChatMemberListEntry.SidebarVoiceChatMemberListEntry_C.BP_OnHovered // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void ExecuteUbergraph_SidebarVoiceChatMemberListEntry(int32_t EntryPoint); // Function SidebarVoiceChatMemberListEntry.SidebarVoiceChatMemberListEntry_C.ExecuteUbergraph_SidebarVoiceChatMemberListEntry // (Final|UbergraphFunction) // @ game+0xda071c
};
