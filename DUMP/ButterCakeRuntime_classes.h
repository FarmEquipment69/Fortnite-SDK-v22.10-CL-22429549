...
struct UButterCakeUnstuckComponent : UActorComponent {
	...
	void ResetUnstuckLocationSamples(); // Function ButterCakeRuntime.ButterCakeUnstuckComponent.ResetUnstuckLocationSamples // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x65bbd1c
	void HandleAthenaGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function ButterCakeRuntime.ButterCakeUnstuckComponent.HandleAthenaGamePhaseChanged // (Final|Native|Private) // @ game+0x65bba30
};
...
struct UFortAIAnimInstance_ButterCake : UFortAIAnimInstance {
	...
	void SetFootPhaseMembers(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.SetFootPhaseMembers // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbd30
	float ComputeLeanAngleByVelocity(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.ComputeLeanAngleByVelocity // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65bb8c8
	enum class EFortButterCakeFootPhase ComputeFootPhase(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.ComputeFootPhase // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65bb8a4
};
...
struct UFortButterCakeComponent_Telemetry : UFortAIComponent_Telemetry {
	...
	void OnLured(); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnLured // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbd08
	void OnItemsSneezed(int32_t ItemsCount); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnItemsSneezed // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbc84
	void OnItemsEaten(int32_t ItemsCount); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnItemsEaten // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbc08
	void OnEnterBerserk(struct AController* Instigator); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnEnterBerserk // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbb28
	void OnBlowHoleUsed(); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnBlowHoleUsed // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbb14
};
...
struct UFortButterCakeControlRig : UControlRig {
	...
	struct FVector GetGroundHitNormalAt(int32_t Index); // Function ButterCakeRuntime.FortButterCakeControlRig.GetGroundHitNormalAt // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x65bb990
	struct FVector GetGroundHitLocationAt(int32_t Index); // Function ButterCakeRuntime.FortButterCakeControlRig.GetGroundHitLocationAt // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x65bb8f0
};
