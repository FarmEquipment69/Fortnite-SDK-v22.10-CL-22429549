// Enum LandscapePatch.ELandscapeTextureHeightPatchInitMode
enum class ELandscapeTextureHeightPatchInitMode : uint8 {
	FromLandscape = 0,
	TextureAsset = 1,
	Blank = 2,
	ELandscapeTextureHeightPatchInitMode_MAX = 3
};

// Enum LandscapePatch.ELandscapeTextureHeightPatchBlendMode
...
// Enum LandscapePatch.ELandscapeTextureHeightPatchFalloffMode
enum class ELandscapeTextureHeightPatchFalloffMode : uint8 {
	Circle = 0,
	RoundedRectangle = 1,
	ELandscapeTextureHeightPatchFalloffMode_MAX = 2
};
