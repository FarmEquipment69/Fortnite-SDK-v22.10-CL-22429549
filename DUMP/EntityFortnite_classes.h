...
struct AEntityFortniteStormSpawner : AActor {
	...
	void Stop(); // Function EntityFortnite.EntityFortniteStormSpawner.Stop // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void Start(float StartRadius, float BoundsRadius, struct TArray<struct FEntityFortniteStormPhase>& Phases); // Function EntityFortnite.EntityFortniteStormSpawner.Start // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void Pause(); // Function EntityFortnite.EntityFortniteStormSpawner.Pause // (Event|Public|BlueprintEvent) // @ game+0xda071c
	bool Exists(); // Function EntityFortnite.EntityFortniteStormSpawner.Exists // (Event|Public|BlueprintEvent|Const) // @ game+0xda071c
};
