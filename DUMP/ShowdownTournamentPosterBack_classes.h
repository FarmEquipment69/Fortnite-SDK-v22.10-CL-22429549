...
struct UShowdownTournamentPosterBack_C : UFortShowdownDetailView {
	...
	void GetTournamentDateText(struct FText& TournamentDate); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.GetTournamentDateText // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void RefreshDataBP(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void EventColorize(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void EventPopulateEventWindowData(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.EventPopulateEventWindowData // (BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	void Construct(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda071c
	void ExecuteUbergraph_ShowdownTournamentPosterBack(int32_t EntryPoint); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.ExecuteUbergraph_ShowdownTournamentPosterBack // (Final|UbergraphFunction|HasDefaults) // @ game+0xda071c
};
