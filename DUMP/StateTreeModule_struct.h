...
enum class EStateTreePropertyCopyType : uint8 {
	...
	PromoteFloatToDouble = 25,
	DemoteDoubleToFloat = 26,
	EStateTreePropertyCopyType_MAX = 27
};
...
struct FStateTreeExecutionContext {
	...
	struct FStateTreeInstanceData InternalInstanceData; // 0x18(0x20)
...
struct FCompactStateTransition {
	uint16_t ConditionsBegin; // 0x00(0x02)
	struct FStateTreeStateHandle State; // 0x02(0x02)
	enum class EStateTreeTransitionType Type; // 0x04(0x01)
	enum class EStateTreeTransitionEvent event; // 0x05(0x01)
	char GateDelay; // 0x06(0x01)
	char ConditionsNum; // 0x07(0x01)
};
