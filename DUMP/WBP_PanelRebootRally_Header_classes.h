...
struct UWBP_PanelRebootRally_Header_C : UFortSidebarPanelRebootHeader {
	...
	void Construct(); // Function WBP_PanelRebootRally_Header.WBP_PanelRebootRally_Header_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnRebootRallyEligibilityUpdated(bool bEligible); // Function WBP_PanelRebootRally_Header.WBP_PanelRebootRally_Header_C.OnRebootRallyEligibilityUpdated // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void ExecuteUbergraph_WBP_PanelRebootRally_Header(int32_t EntryPoint); // Function WBP_PanelRebootRally_Header.WBP_PanelRebootRally_Header_C.ExecuteUbergraph_WBP_PanelRebootRally_Header // (Final|UbergraphFunction|HasDefaults) // @ game+0xda071c
};
