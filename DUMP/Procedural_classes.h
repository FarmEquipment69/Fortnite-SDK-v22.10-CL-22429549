...
struct UHISMBuilderSettings : UObject {
	...
	void SetOverriddenLightMapRes(int32_t Value); // Function Procedural.HISMBuilderSettings.SetOverriddenLightMapRes // (Final|Native|Public|BlueprintCallable) // @ game+0x720d654
	int32_t GetOverriddenLightMapRes(); // Function Procedural.HISMBuilderSettings.GetOverriddenLightMapRes // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5f8acd4
};
...
struct UProceduralParameterModifier : UObject {
	...
	float GetContribution(); // Function Procedural.ProceduralParameterModifier.GetContribution // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d2b0
};
...
struct UProceduralGenerationContext : UObject {
	...
	struct AVolume* GetGenerationVolume(); // Function Procedural.ProceduralGenerationContext.GetGenerationVolume // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d3b8
	struct UProceduralGenerationComponent* GetGenerationComponent(); // Function Procedural.ProceduralGenerationContext.GetGenerationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d370
};
...
struct AProceduralGenerationVolume : AVolume {
	...
	void Generate(); // Function Procedural.ProceduralGenerationVolume.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x720d270
	void ClearGeneratedContent(); // Function Procedural.ProceduralGenerationVolume.ClearGeneratedContent // (Final|Native|Public|BlueprintCallable) // @ game+0x720d1bc
};
...
struct UProceduralGeneratorContext : UObject {
	...
	bool OnGenerate(); // Function Procedural.ProceduralGeneratorContext.OnGenerate // (Native|Event|Public|BlueprintEvent) // @ game+0x27a81c4
	void OnDrawVisualization(); // Function Procedural.ProceduralGeneratorContext.OnDrawVisualization // (Event|Public|BlueprintEvent|Const) // @ game+0xda071c
	void OnClearGeneratedContent(); // Function Procedural.ProceduralGeneratorContext.OnClearGeneratedContent // (Native|Event|Public|BlueprintEvent) // @ game+0x132bf94
	void GetOrCreateGeneratorContext(struct UProceduralGenerator* Generator, struct UProceduralGeneratorContext*& Context); // Function Procedural.ProceduralGeneratorContext.GetOrCreateGeneratorContext // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x720d414
	struct TArray<struct UProceduralGeneratorContext*> GetGeneratedContexts(); // Function Procedural.ProceduralGeneratorContext.GetGeneratedContexts // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d2d0
	bool Generate(); // Function Procedural.ProceduralGeneratorContext.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x720d28c
	void ClearGeneratedContent(); // Function Procedural.ProceduralGeneratorContext.ClearGeneratedContent // (Final|Native|Public|BlueprintCallable) // @ game+0x720d1ec
};
...
struct UProceduralPointCloud : UObject {
	...
	struct TArray<struct FProceduralPointCloudPoint> GetPointsByTag(struct FName InTag); // Function Procedural.ProceduralPointCloud.GetPointsByTag // (Final|Native|Public|BlueprintCallable) // @ game+0x720d4e4
	void Empty(); // Function Procedural.ProceduralPointCloud.Empty // (Final|Native|Public|BlueprintCallable) // @ game+0x720d200
};
...
struct UProceduralRotationMapModifier : UProceduralRotationModifier {
	...
	void SetYawMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetYawMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720dacc
	void SetYawMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetYawMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720da3c
	void SetRollMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetRollMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720dbec
	void SetRollMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetRollMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720db5c
	void SetPitchMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetPitchMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d76c
	void SetPitchMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetPitchMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d6dc
	float GetYawMin(); // Function Procedural.ProceduralRotationMapModifier.GetYawMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d62c
	float GetYawMax(); // Function Procedural.ProceduralRotationMapModifier.GetYawMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d618
	float GetRollMin(); // Function Procedural.ProceduralRotationMapModifier.GetRollMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d640
	float GetRollMax(); // Function Procedural.ProceduralRotationMapModifier.GetRollMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278f140
	float GetPitchMin(); // Function Procedural.ProceduralRotationMapModifier.GetPitchMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278f12c
	float GetPitchMax(); // Function Procedural.ProceduralRotationMapModifier.GetPitchMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23cee98
};
...
struct UProceduralRotationNoiseModifier : UProceduralRotationModifier {
	...
	void SetRandomYawMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomYawMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720dacc
	void SetRandomYawMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomYawMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720da3c
	void SetRandomRollMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomRollMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d9ac
	void SetRandomRollMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomRollMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d91c
	void SetRandomPitchMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomPitchMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d88c
	void SetRandomPitchMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomPitchMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d7fc
	float GetRandomYawMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomYawMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d62c
	float GetRandomYawMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomYawMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d618
	float GetRandomRollMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomRollMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f7268
	float GetRandomRollMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomRollMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d604
	float GetRandomPitchMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomPitchMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278f140
	float GetRandomPitchMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomPitchMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278f12c
};
...
struct UProceduralScaleMapModifier : UProceduralScaleModifier {
	...
	void SetRemapScaleMin(float InValue); // Function Procedural.ProceduralScaleMapModifier.SetRemapScaleMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d9ac
	void SetRemapScaleMax(float InValue); // Function Procedural.ProceduralScaleMapModifier.SetRemapScaleMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d91c
	float GetRemapScaleMin(); // Function Procedural.ProceduralScaleMapModifier.GetRemapScaleMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f7268
	float GetRemapScaleMax(); // Function Procedural.ProceduralScaleMapModifier.GetRemapScaleMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d604
};
...
struct UProceduralScaleNoiseModifier : UProceduralScaleModifier {
	...
	void SetScaleMin(float InValue); // Function Procedural.ProceduralScaleNoiseModifier.SetScaleMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720e418
	void SetScaleMax(float InValue); // Function Procedural.ProceduralScaleNoiseModifier.SetScaleMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720e388
	float GetScaleMin(); // Function Procedural.ProceduralScaleNoiseModifier.GetScaleMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5f8acd4
	float GetScaleMax(); // Function Procedural.ProceduralScaleNoiseModifier.GetScaleMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f7268
};
...
struct UProceduralScatterSettings : UObject {
	...
	void SetSourcePointDistanceMin(float InValue); // Function Procedural.ProceduralScatterSettings.SetSourcePointDistanceMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720e540
	void SetSourcePointDistanceMax(float InValue); // Function Procedural.ProceduralScatterSettings.SetSourcePointDistanceMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720e4a8
	float GetSourcePointDistanceMin(); // Function Procedural.ProceduralScatterSettings.GetSourcePointDistanceMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720e370
	float GetSourcePointDistanceMax(); // Function Procedural.ProceduralScatterSettings.GetSourcePointDistanceMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720e358
};
...
struct UProceduralSurfaceHeightMap : UProceduralFloatDataMap {
	...
	void SetHeightRangeMin(float InValue); // Function Procedural.ProceduralSurfaceHeightMap.SetHeightRangeMin // (Final|Native|Public|BlueprintCallable) // @ game+0x722efc8
	void SetHeightRangeMax(float InValue); // Function Procedural.ProceduralSurfaceHeightMap.SetHeightRangeMax // (Final|Native|Public|BlueprintCallable) // @ game+0x722ef30
	float GetValue(float InHeight); // Function Procedural.ProceduralSurfaceHeightMap.GetValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x722ee9c
	float GetHeightRangeMin(); // Function Procedural.ProceduralSurfaceHeightMap.GetHeightRangeMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x647368c
	float GetHeightRangeMax(); // Function Procedural.ProceduralSurfaceHeightMap.GetHeightRangeMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x643c33c
};
...
struct UProceduralSurfaceSlopeAngleMap : UProceduralFloatDataMap {
	...
	void SetSlopeAngleRangeMin(float InValue); // Function Procedural.ProceduralSurfaceSlopeAngleMap.SetSlopeAngleRangeMin // (Final|Native|Public|BlueprintCallable) // @ game+0x722efc8
	void SetSlopeAngleRangeMax(float InValue); // Function Procedural.ProceduralSurfaceSlopeAngleMap.SetSlopeAngleRangeMax // (Final|Native|Public|BlueprintCallable) // @ game+0x722ef30
	float GetValue(float InSlopeAngle); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x722ee9c
	float GetSlopeAngleRangeMin(); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetSlopeAngleRangeMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x647368c
	float GetSlopeAngleRangeMax(); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetSlopeAngleRangeMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x643c33c
};
