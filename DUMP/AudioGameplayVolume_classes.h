...
struct UAudioGameplayVolumeMutator : UAudioGameplayComponent {
	...
	void SetPriority(int32_t InPriority); // Function AudioGameplayVolume.AudioGameplayVolumeMutator.SetPriority // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3f08
};
...
struct UAttenuationVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetInteriorVolume(float Volume, float InterpolateTime); // Function AudioGameplayVolume.AttenuationVolumeComponent.SetInteriorVolume // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3e34
	void SetExteriorVolume(float Volume, float InterpolateTime); // Function AudioGameplayVolume.AttenuationVolumeComponent.SetExteriorVolume // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3d60
};
...
struct AAudioGameplayVolume : AVolume {
	...
	void SetEnabled(bool bEnable); // Function AudioGameplayVolume.AudioGameplayVolume.SetEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3cc8
	void OnRep_bEnabled(); // Function AudioGameplayVolume.AudioGameplayVolume.OnRep_bEnabled // (Native|Protected) // @ game+0x679e3a0
	void OnListenerExit(); // Function AudioGameplayVolume.AudioGameplayVolume.OnListenerExit // (Native|Event|Public|BlueprintEvent) // @ game+0x24c3e10
	void OnListenerEnter(); // Function AudioGameplayVolume.AudioGameplayVolume.OnListenerEnter // (Native|Event|Public|BlueprintEvent) // @ game+0x24c3de8
};
...
struct UFilterVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetInteriorLPF(float Volume, float InterpolateTime); // Function AudioGameplayVolume.FilterVolumeComponent.SetInteriorLPF // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3e34
	void SetExteriorLPF(float Volume, float InterpolateTime); // Function AudioGameplayVolume.FilterVolumeComponent.SetExteriorLPF // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3d60
};
...
struct UReverbVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetReverbSettings(struct FReverbSettings& NewReverbSettings); // Function AudioGameplayVolume.ReverbVolumeComponent.SetReverbSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x70c3f94
};
...
struct USubmixOverrideVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetSubmixOverrideSettings(struct TArray<struct FAudioVolumeSubmixOverrideSettings>& NewSubmixOverrideSettings); // Function AudioGameplayVolume.SubmixOverrideVolumeComponent.SetSubmixOverrideSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x70c4058
};
...
struct USubmixSendVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetSubmixSendSettings(struct TArray<struct FAudioVolumeSubmixSendSettings>& NewSubmixSendSettings); // Function AudioGameplayVolume.SubmixSendVolumeComponent.SetSubmixSendSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x70c40fc
};
