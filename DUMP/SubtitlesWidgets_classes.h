...
struct UFortMediaSubtitlesPlayer : UObject {
	...
	void Stop(); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Stop // (Final|Native|Public|BlueprintCallable) // @ game+0x6927ffc
	void SetSubtitles(struct UOverlays* Subtitles); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.SetSubtitles // (Final|Native|Public|BlueprintCallable) // @ game+0x6927f80
	void Play(); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Play // (Final|Native|Public|BlueprintCallable) // @ game+0x6927f6c
	void BindToMediaPlayer(struct UMediaPlayer* InMediaPlayer); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.BindToMediaPlayer // (Final|Native|Public|BlueprintCallable) // @ game+0x6927e34
};
...
struct USubtitleDisplay : UWidget {
	...
	bool HasSubtitles(); // Function SubtitlesWidgets.SubtitleDisplay.HasSubtitles // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6927f2c
};
