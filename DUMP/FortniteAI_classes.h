...
struct UFortAIComponent_Telemetry : UActorComponent {
	...
	void OnTetheredFollowerChanged(struct AFortPawn* NewFollower, struct AFortPawn* OldFollower); // Function FortniteAI.FortAIComponent_Telemetry.OnTetheredFollowerChanged // (Final|Native|Private) // @ game+0x990fe60
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIComponent_Telemetry.OnPawnDied // (Final|Native|Private|HasDefaults) // @ game+0x990fbe4
	void OnDidDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIComponent_Telemetry.OnDidDamage // (Final|Native|Private|HasDefaults) // @ game+0x990f968
	struct UFortAthenaAITelemetryData* GetOrCreateTelemetryData(struct UFortAthenaAITelemetryData* TelemetryDataClass); // Function FortniteAI.FortAIComponent_Telemetry.GetOrCreateTelemetryData // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990f718
};
...
struct AFortAIController : AAIController {
	...
	void WakeUp(); // Function FortniteAI.FortAIController.WakeUp // (Final|Native|Public|BlueprintCallable) // @ game+0x9910614
	void UnlockMovementResource(); // Function FortniteAI.FortAIController.UnlockMovementResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x99105e0
	void UnlockBehaviorResource(); // Function FortniteAI.FortAIController.UnlockBehaviorResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x99105ac
	void SetupCustomVIM(struct UObject* VIM); // Function FortniteAI.FortAIController.SetupCustomVIM // (Final|Native|Public|BlueprintCallable) // @ game+0x99104f8
	void SetTeamInt(char InTeam); // Function FortniteAI.FortAIController.SetTeamInt // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x99103f4
	void SetTeam(enum class EFortTeam InTeam); // Function FortniteAI.FortAIController.SetTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x99103f4
	void SetPawnAIType(enum class EFortressAIType NewAIType, struct AActor* SpawnSpot); // Function FortniteAI.FortAIController.SetPawnAIType // (Final|Native|Public|BlueprintCallable) // @ game+0x9910310
	void SetIsSleeping(bool bNewSleepStatus); // Function FortniteAI.FortAIController.SetIsSleeping // (Final|Native|Public|BlueprintCallable) // @ game+0x9910290
	void SetGoalActor(struct AActor* InActor, bool bLocationAlwaysKnown); // Function FortniteAI.FortAIController.SetGoalActor // (Final|Native|Public|BlueprintCallable) // @ game+0x99101c8
	void SetFullPeripheralVision(bool bNewFullPeripheralVision); // Function FortniteAI.FortAIController.SetFullPeripheralVision // (Final|Native|Public|BlueprintCallable) // @ game+0x9910138
	void SetAlwaysGameplayRelevant(bool bInAlwaysGameplayRelevant); // Function FortniteAI.FortAIController.SetAlwaysGameplayRelevant // (Final|Native|Public|BlueprintCallable) // @ game+0x99100a4
	void OnBuildingActorGoalDestroyed(); // Function FortniteAI.FortAIController.OnBuildingActorGoalDestroyed // (Final|Native|Public) // @ game+0x990f950
	void OnActorGoalDestroyed(struct AActor* DestroyedActor); // Function FortniteAI.FortAIController.OnActorGoalDestroyed // (Final|Native|Public) // @ game+0x990f8d0
	void LockMovementResource(); // Function FortniteAI.FortAIController.LockMovementResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990f89c
	void LockBehaviorResource(); // Function FortniteAI.FortAIController.LockBehaviorResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990f868
	bool IsIgnoringProximity(struct AFortAIController* FortAIController); // Function FortniteAI.FortAIController.IsIgnoringProximity // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x73d4d94
	bool IsAllowedToSleep(); // Function FortniteAI.FortAIController.IsAllowedToSleep // (Final|Native|Public|BlueprintCallable) // @ game+0x990f830
	void IgnoreProximityForDuration(float DurationToIgnore); // Function FortniteAI.FortAIController.IgnoreProximityForDuration // (RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990f7a8
	struct AActor* GetGoalActor(); // Function FortniteAI.FortAIController.GetGoalActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x73d47ac
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIController.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990f46c
	bool CreateBuildingActor(struct ABuildingSMActor* BuildingClass, struct FVector BuildLoc, struct FRotator BuildRot, bool bMirrored); // Function FortniteAI.FortAIController.CreateBuildingActor // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x990f284
	void ClearAllFocalPoints(); // Function FortniteAI.FortAIController.ClearAllFocalPoints // (Final|Native|Public|BlueprintCallable) // @ game+0x990f224
};
...
struct UAthenaAIServicePlayerBots : UAthenaAIService {
	...
	struct APawn* SpawnAI(struct FVector& InSpawnLocation, struct FRotator& InSpawnRotation, struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList); // Function FortniteAI.AthenaAIServicePlayerBots.SpawnAI // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990d90c
	void OnServerGameMemberRemoved(char InSquadId, char InTeamIndex, struct AFortPlayerStateAthena* ChangedPS); // Function FortniteAI.AthenaAIServicePlayerBots.OnServerGameMemberRemoved // (Final|Native|Private) // @ game+0x990d55c
	void OnSafeZoneUpdated(); // Function FortniteAI.AthenaAIServicePlayerBots.OnSafeZoneUpdated // (Final|Native|Private) // @ game+0x990d548
	void OnPawnSpawned(struct APawn* Pawn, int32_t RequestId, bool bIsRespawn); // Function FortniteAI.AthenaAIServicePlayerBots.OnPawnSpawned // (Final|Native|Private) // @ game+0x990d298
	void OnGamePhaseChanged(enum class EAthenaGamePhase NewPhase); // Function FortniteAI.AthenaAIServicePlayerBots.OnGamePhaseChanged // (Native|Protected) // @ game+0x990d120
	void OnAgentGameOver(struct AFortAthenaAIBotController* AIBotController, struct AFortPawn* Pawn, struct AController* Instigator); // Function FortniteAI.AthenaAIServicePlayerBots.OnAgentGameOver // (Final|Native|Private) // @ game+0x990cdac
	void KillBots(bool bKillPlayers, bool bKillNoneParticipants, char TeamIndex, struct AActor* BotOwner); // Function FortniteAI.AthenaAIServicePlayerBots.KillBots // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990ca1c
	void JoinTeam(struct AController* SourceTeamController, struct AController* DestinationTeamController); // Function FortniteAI.AthenaAIServicePlayerBots.JoinTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x990c76c
	bool IsWeaponSupported(struct AFortWeapon* FortWeapon); // Function FortniteAI.AthenaAIServicePlayerBots.IsWeaponSupported // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990c644
};
...
struct UAthenaAIServiceCreativePlayerBots : UAthenaAIServicePlayerBots {
	...
	struct APlayerController* GetLastHiringPlayer(struct AActor* HiredOwner); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.GetLastHiringPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c3fc
	void ClearHiringHistory(struct AActor* HiredOwner); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.ClearHiringHistory // (Final|Native|Public|BlueprintCallable) // @ game+0x990c0f8
	void AddHiringHistory(struct AActor* HiredOwner, struct APlayerController* HiringPlayer); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.AddHiringHistory // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990bf6c
};
...
struct AFortAthenaAIBotController : AAIController {
	...
	void UpdateLeashActorToFollowLocation(); // Function FortniteAI.FortAthenaAIBotController.UpdateLeashActorToFollowLocation // (Final|Native|Protected) // @ game+0x991e31c
	void ThankBusDriver(); // Function FortniteAI.FortAthenaAIBotController.ThankBusDriver // (Final|Native|Protected) // @ game+0x991e308
	void SwitchTeam(char TeamIndex); // Function FortniteAI.FortAthenaAIBotController.SwitchTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x991e1ac
	void StopSecondaryFire(bool bFireWhenStopping); // Function FortniteAI.FortAthenaAIBotController.StopSecondaryFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991e0d8
	void StopFire(); // Function FortniteAI.FortAthenaAIBotController.StopFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991e0c4
	void StopEmote(); // Function FortniteAI.FortAthenaAIBotController.StopEmote // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991e0b0
	void StartSecondaryFire(); // Function FortniteAI.FortAthenaAIBotController.StartSecondaryFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991e034
	void StartFire(); // Function FortniteAI.FortAthenaAIBotController.StartFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991e020
	void SetSkillSet(struct UFortAthenaAIBotSkillSet* SkillSetClass); // Function FortniteAI.FortAthenaAIBotController.SetSkillSet // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991df54
	void SetRadialLeashOuterRadius(float OuterRadius); // Function FortniteAI.FortAthenaAIBotController.SetRadialLeashOuterRadius // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991ded0
	void SetRadialLeashInnerRadius(float InnerRadius); // Function FortniteAI.FortAthenaAIBotController.SetRadialLeashInnerRadius // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991de4c
	void SetPatrollingEnable(bool bEnable); // Function FortniteAI.FortAthenaAIBotController.SetPatrollingEnable // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991ddcc
	void SetLeashVolume(struct AFortAthenaAILeashVolume* InLeashVolume); // Function FortniteAI.FortAthenaAIBotController.SetLeashVolume // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991dd30
	void SetLeashReturnLocationMode(enum class ELeashReturnLocationMode ReturnMode); // Function FortniteAI.FortAthenaAIBotController.SetLeashReturnLocationMode // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991dcb4
	void SetLeashActorToFollow(struct AActor* ActorToFollow, float LeashLocationUpdateRate, struct FVector LocalOffset); // Function FortniteAI.FortAthenaAIBotController.SetLeashActorToFollow // (Final|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x991dba4
	void SetBotOwner(struct AActor* InBotOwner); // Function FortniteAI.FortAthenaAIBotController.SetBotOwner // (Final|Native|Public|BlueprintCallable) // @ game+0x991db24
	void RequestEmote(struct FPrimaryAssetId& EmotePrimaryAssetId, float InfiniteEmoteMaxDuration); // Function FortniteAI.FortAthenaAIBotController.RequestEmote // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991da50
	void RemoveSkillSet(struct UFortAthenaAIBotSkillSet* SkillSetClass); // Function FortniteAI.FortAthenaAIBotController.RemoveSkillSet // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991d948
	void RemoveEmoteRequest(); // Function FortniteAI.FortAthenaAIBotController.RemoveEmoteRequest // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991d934
	void ReleaseBuildTool(); // Function FortniteAI.FortAthenaAIBotController.ReleaseBuildTool // (Final|Native|Protected) // @ game+0x991d920
	void QueueStim(struct AActor* SourceActor, struct FVector& SourceLocation, struct FVector& SourceDirection, enum class EStimType NewStimType, float StimStrength, struct FName StimTag); // Function FortniteAI.FortAthenaAIBotController.QueueStim // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991d72c
	void PlayEmote(struct FPrimaryAssetId& EmotePrimaryAssetId); // Function FortniteAI.FortAthenaAIBotController.PlayEmote // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991d6a0
	void OverrideSkill(float NewSkill); // Function FortniteAI.FortAthenaAIBotController.OverrideSkill // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991d61c
	void OverrideAggressivenessPlayStyle(bool bInIsAggressive); // Function FortniteAI.FortAthenaAIBotController.OverrideAggressivenessPlayStyle // (Final|Native|Public|BlueprintCallable) // @ game+0x991d590
	void OnTargetPawnDestroyed(); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDestroyed // (Final|Native|Public) // @ game+0x991d57c
	void OnTargetPawnDead(struct AFortPawn* FortPawn); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDead // (Final|Native|Public) // @ game+0x991d4fc
	void OnTargetPawnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDamaged // (Final|Native|Public|HasDefaults) // @ game+0x502a610
	void OnTargetBuildingDestroyed(struct ABuildingActor* Building, struct AAthenaAIController* AIController); // Function FortniteAI.FortAthenaAIBotController.OnTargetBuildingDestroyed // (Final|Native|Public) // @ game+0x991d438
	void OnTargetActorDestroyed(struct AActor* DestroyedActor); // Function FortniteAI.FortAthenaAIBotController.OnTargetActorDestroyed // (Final|Native|Public) // @ game+0x991d3b8
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // Function FortniteAI.FortAthenaAIBotController.OnServerMarkerAdded // (Final|Native|Public|HasOutParms) // @ game+0x991d314
	void OnSafeZoneUpdated(); // Function FortniteAI.FortAthenaAIBotController.OnSafeZoneUpdated // (Final|Native|Public) // @ game+0x991d280
	void OnSafezoneStateChanged(enum class EFortSafeZoneState NewState); // Function FortniteAI.FortAthenaAIBotController.OnSafezoneStateChanged // (Final|Native|Public) // @ game+0x991d294
	void OnPossessedPawnReceiveDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPossessedPawnReceiveDamage // (Final|Native|Public|HasDefaults) // @ game+0x991d004
	void OnPossesedPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPossesedPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x991cdd0
	void OnPerceptionSensed(struct AActor* SourceActor, struct FAIStimulus Stim); // Function FortniteAI.FortAthenaAIBotController.OnPerceptionSensed // (Native|Public) // @ game+0x991cce0
	void OnPawnWeaponChanged(struct AFortWeapon* NewWeapon, struct AFortWeapon* OldWeapon); // Function FortniteAI.FortAthenaAIBotController.OnPawnWeaponChanged // (Final|Native|Public) // @ game+0x991cc1c
	void OnPawnDidDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* HitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPawnDidDamage // (Final|Native|Public|HasDefaults) // @ game+0x991c9a0
	void OnMovementModeChange(struct ACharacter* InCharacter, enum class EMovementMode PrevMovementMode, char PreviousCustomMode); // Function FortniteAI.FortAthenaAIBotController.OnMovementModeChange // (Final|Native|Public) // @ game+0x991c858
	void OnLaunched(struct FVector LaunchVelocity, bool bXYOverride, bool bZOverride); // Function FortniteAI.FortAthenaAIBotController.OnLaunched // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x991c73c
	void OnKnockbacked(struct FGameplayTag KnockbackTypeTag); // Function FortniteAI.FortAthenaAIBotController.OnKnockbacked // (Final|Native|Public|BlueprintCallable) // @ game+0x991c6bc
	void OnGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.FortAthenaAIBotController.OnGamePhaseStepChanged // (Final|Native|Public|HasOutParms) // @ game+0x991c5dc
	void OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.FortAthenaAIBotController.OnGamePhaseChanged // (Final|Native|Public) // @ game+0x991c55c
	void OnEndSpectating(struct AFortPlayerStateZone* Spectator); // Function FortniteAI.FortAthenaAIBotController.OnEndSpectating // (Final|Native|Public) // @ game+0x651d978
	void OnCurrentHarvestableDestroyed(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnCurrentHarvestableDestroyed // (Final|Native|Protected|HasDefaults) // @ game+0x991c330
	void OnBeginSpectating(struct AFortPlayerStateZone* Spectator); // Function FortniteAI.FortAthenaAIBotController.OnBeginSpectating // (Final|Native|Public) // @ game+0x651d978
	void OnAlertLevelChanged(enum class EAlertLevel OldAlertLevel, enum class EAlertLevel NewAlertLevel); // Function FortniteAI.FortAthenaAIBotController.OnAlertLevelChanged // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnAgentDBNO(struct AFortPawn* InPlayer, bool bInIsDBNO); // Function FortniteAI.FortAthenaAIBotController.OnAgentDBNO // (Final|Native|Public) // @ game+0x991c268
	void NotifyPickupsSpawnedOnDeath(struct TArray<struct AFortPickup*>& SpawnedPickups); // Function FortniteAI.FortAthenaAIBotController.NotifyPickupsSpawnedOnDeath // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x65914c0
	bool IsAnAthenaGameParticipant(); // Function FortniteAI.FortAthenaAIBotController.IsAnAthenaGameParticipant // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991c24c
	struct UAthenaMarkerComponent* GetMarkerComponent(); // Function FortniteAI.FortAthenaAIBotController.GetMarkerComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991c234
	struct AActor* GetCurrentThreat(); // Function FortniteAI.FortAthenaAIBotController.GetCurrentThreat // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991c1f4
	struct AActor* GetBotOwner(); // Function FortniteAI.FortAthenaAIBotController.GetBotOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991c1dc
	struct AFortWeapon* EquipWeaponByTag(struct FGameplayTag& WeaponTag); // Function FortniteAI.FortAthenaAIBotController.EquipWeaponByTag // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x991c144
	struct AFortWeapon* EquipWeapon(struct UFortWorldItem* Weapon); // Function FortniteAI.FortAthenaAIBotController.EquipWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x991c0b4
	struct AFortWeapon* EquipMeleeWeapon(); // Function FortniteAI.FortAthenaAIBotController.EquipMeleeWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x991c01c
	struct AFortWeapon* EquipBestWeapon(); // Function FortniteAI.FortAthenaAIBotController.EquipBestWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x991bff8
	...
	void Cheat_ClearForcedCosmeticItems(); // Function FortniteAI.FortAthenaAIBotController.Cheat_ClearForcedCosmeticItems // (Net|NetReliableNative|Event|Public|NetServer|NetValidate) // @ game+0x991be88
	void ChangeActiveVariantForCosmeticItem(struct FName ItemTemplateToChange, struct FGameplayTag VariantChannelToChange, struct FGameplayTag DesiredActiveVariant); // Function FortniteAI.FortAthenaAIBotController.ChangeActiveVariantForCosmeticItem // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991bd90
	void BlueprintOnBehaviorTreeStarted(); // Function FortniteAI.FortAthenaAIBotController.BlueprintOnBehaviorTreeStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void AddTargetInfos(struct TArray<struct AActor*>& Targets, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.FortAthenaAIBotController.AddTargetInfos // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x991bc1c
	void AddTargetInfo(struct AActor* Target, bool bForceTarget, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.FortAthenaAIBotController.AddTargetInfo // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991ba84
};
...
struct UFortNavModifierComponent : UNavModifierComponent {
	...
	void SetComponentAffectingNavMesh(struct UPrimitiveComponent* InComponentAffectingNavMesh); // Function FortniteAI.FortNavModifierComponent.SetComponentAffectingNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992d438
};
...
struct UFortPhysicsObjectNavigationComponent : UFortNavModifierComponent {
	...
	void OnSleepStateChanged(struct UPrimitiveComponent* SimulatingComponent, bool bIsAwake); // Function FortniteAI.FortPhysicsObjectNavigationComponent.OnSleepStateChanged // (Final|RequiredAPI|Native|Protected) // @ game+0x992d018
};
...
struct AAIHotSpot : AActor {
	...
	void SetEnabled(bool bEnabled); // Function FortniteAI.AIHotSpot.SetEnabled // (Native|Public|BlueprintCallable) // @ game+0x990aee0
	int32_t RemoveGroupFromHotspot(struct TArray<struct AAIController*> GroupOfAI); // Function FortniteAI.AIHotSpot.RemoveGroupFromHotspot // (Native|Public|BlueprintCallable) // @ game+0x990adf4
	bool RemoveFromHotspot(struct AAIController* AI, bool bAssignFromWaitingList); // Function FortniteAI.AIHotSpot.RemoveFromHotspot // (Native|Public|BlueprintCallable) // @ game+0x990ad28
	void OnSlotOccupied(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotOccupied // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990ac2c
	void OnSlotFreed(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotFreed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990ab30
	void OnSlotEnabled(int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotEnabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990aa6c
	void OnSlotDisabled(int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotDisabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a9a8
	void OnSlotClaimed(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotClaimed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a8ac
	void OnSlotBlocked(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotBlocked // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a7b0
	void OnRemovedSlotlessBehavior(struct AAIController* AI, bool bIsClamingSlot); // Function FortniteAI.AIHotSpot.OnRemovedSlotlessBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a6e4
	void OnRemovedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId, enum class EAIHotSpotSlot PrevState, bool bWasOnWaitingList); // Function FortniteAI.AIHotSpot.OnRemovedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a560
	void OnMoveToSlotFinished(struct AAIController* AI, int32_t Index, int32_t UserId, bool bResult); // Function FortniteAI.AIHotSpot.OnMoveToSlotFinished // (BlueprintAuthorityOnly|Native|Event|Protected|BlueprintEvent) // @ game+0x990a420
	void OnHotSpotEnabled(); // Function FortniteAI.AIHotSpot.OnHotSpotEnabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x1652184
	void OnHotSpotDisabled(); // Function FortniteAI.AIHotSpot.OnHotSpotDisabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x16d0580
	bool OnAssignedSlotlessBehavior(struct AAIController* AI); // Function FortniteAI.AIHotSpot.OnAssignedSlotlessBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a38c
	bool OnAssignedOccupiedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnAssignedOccupiedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a28c
	bool OnAssignedClaimedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId, bool bWasOnWaitingList); // Function FortniteAI.AIHotSpot.OnAssignedClaimedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a148
	bool OccupySlotByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.OccupySlotByIndex // (Native|Public|BlueprintCallable) // @ game+0x76eb190
	bool IsSlotlessAssignmentAllowed(); // Function FortniteAI.AIHotSpot.IsSlotlessAssignmentAllowed // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909aa8
	bool IsEnabled(); // Function FortniteAI.AIHotSpot.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99097c8
	bool IsAIAllowed(struct AAIController* AI); // Function FortniteAI.AIHotSpot.IsAIAllowed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent|Const) // @ game+0x99096a0
	bool HasEnabledSlots(); // Function FortniteAI.AIHotSpot.HasEnabledSlots // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909660
	bool HasAssignedAI(struct AAIController* AI, enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.HasAssignedAI // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990959c
	int32_t GetSlotUserIdByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotUserIdByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909508
	enum class EAIHotSpotSlot GetSlotStateByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotStateByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909450
	enum class EAIHotSpotSlot GetSlotStateByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotStateByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99093bc
	struct FRotator GetSlotRotationByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotRotationByIndex // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909304
	struct AAIController* GetSlotOwnerByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotOwnerByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909218
	struct FVector GetSlotLocationByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotLocationByIndex // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909178
	int32_t GetSlotIndexByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotIndexByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99090c0
	int32_t GetSlotCount(enum class EAIHotSpotSlotFilter Filter); // Function FortniteAI.AIHotSpot.GetSlotCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990901c
	struct UAIHotSpotSlot* GetSlotByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908f80
	struct UAIHotSpotSlot* GetSlotByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotByIndex // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908ef4
	int32_t GetAssignedAICount(enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.GetAssignedAICount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908dd8
	struct TArray<struct AAIController*> GetAssignedAI(enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.GetAssignedAI // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908d0c
	struct TArray<int32_t> FindBestSlotIndices(struct TArray<struct AAIController*> AI); // Function FortniteAI.AIHotSpot.FindBestSlotIndices // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990892c
	int32_t FindBestSlotIndex(struct AAIController* AI); // Function FortniteAI.AIHotSpot.FindBestSlotIndex // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908898
	bool CanUseSlotByIndex(struct AAIController* AI, int32_t Index); // Function FortniteAI.AIHotSpot.CanUseSlotByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99087d4
	bool AssignToSlotByIndex(struct AAIController* AI, int32_t Index); // Function FortniteAI.AIHotSpot.AssignToSlotByIndex // (Native|Public|BlueprintCallable) // @ game+0x99084e0
	bool AssignToHotspot(struct AAIController* AI); // Function FortniteAI.AIHotSpot.AssignToHotspot // (Native|Public|BlueprintCallable) // @ game+0x93314e0
	int32_t AssignGroupToHotspot(struct TArray<struct AAIController*> GroupOfAI); // Function FortniteAI.AIHotSpot.AssignGroupToHotspot // (Native|Public|BlueprintCallable) // @ game+0x99083f4
	void AssignFromWaitingList(); // Function FortniteAI.AIHotSpot.AssignFromWaitingList // (Final|Native|Public|BlueprintCallable) // @ game+0x99083e0
};
...
struct UAIHotSpotSlot : UObject {
	...
	void SetSlotState(enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.SetSlotState // (Native|Public|BlueprintCallable) // @ game+0x990b0b0
	void SetSlotOwnerAndState(struct AAIController* NewOwner, enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.SetSlotOwnerAndState // (Native|Public|BlueprintCallable) // @ game+0x990afe8
	void SetSlotEnabled(bool bNewEnabled); // Function FortniteAI.AIHotSpotSlot.SetSlotEnabled // (Native|Public|BlueprintCallable) // @ game+0x990af64
	void OnStateChanged(struct AAIController* SlotOwner, enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.OnStateChanged // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	bool IsEnabled(); // Function FortniteAI.AIHotSpotSlot.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99097e4
	bool IsAIAllowed(struct AAIController* AI); // Function FortniteAI.AIHotSpotSlot.IsAIAllowed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9909734
	bool HasUserId(); // Function FortniteAI.AIHotSpotSlot.HasUserId // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909684
	int32_t GetSlotUserId(); // Function FortniteAI.AIHotSpotSlot.GetSlotUserId // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99094f0
	enum class EAIHotSpotSlot GetSlotState(); // Function FortniteAI.AIHotSpotSlot.GetSlotState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99093a4
	struct FRotator GetSlotRotation(); // Function FortniteAI.AIHotSpotSlot.GetSlotRotation // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x99092cc
	float GetSlotRadius(); // Function FortniteAI.AIHotSpotSlot.GetSlotRadius // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99092b4
	struct AAIController* GetSlotOwner(); // Function FortniteAI.AIHotSpotSlot.GetSlotOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6a63a78
	struct FVector GetSlotLocation(); // Function FortniteAI.AIHotSpotSlot.GetSlotLocation // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909150
	int32_t GetSlotIndex(); // Function FortniteAI.AIHotSpotSlot.GetSlotIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278f6e4
	float GetSlotHeight(); // Function FortniteAI.AIHotSpotSlot.GetSlotHeight // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99090a8
	struct FBox GetSlotBounds(); // Function FortniteAI.AIHotSpotSlot.GetSlotBounds // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908eac
	struct AAIHotSpot* GetHotSpot(); // Function FortniteAI.AIHotSpotSlot.GetHotSpot // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908e64
	void ClearSlot(); // Function FortniteAI.AIHotSpotSlot.ClearSlot // (Native|Public|BlueprintCallable) // @ game+0x5cf92ec
};
...
struct UAIHotSpotSlotGenerator : UObject {
	...
	struct AAIHotSpot* GetHotSpot(); // Function FortniteAI.AIHotSpotSlotGenerator.GetHotSpot // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908e64
	void GenerateSlots(); // Function FortniteAI.AIHotSpotSlotGenerator.GenerateSlots // (Native|Event|Public|BlueprintEvent) // @ game+0x132bf94
	struct UAIHotSpotSlot* AddSlot(struct FVector& RelativeLocation, struct FRotator& RelativeRotation, struct UAIHotSpotSlot* CustomSlotClass, bool bEnabled); // Function FortniteAI.AIHotSpotSlotGenerator.AddSlot // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908270
};
...
struct UAthenaAIBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void MakeBotGroupsTakeEachOtherAsTargets(struct TArray<struct AActor*>& GroupA, struct TArray<struct AActor*>& GroupB, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.AthenaAIBlueprintLibrary.MakeBotGroupsTakeEachOtherAsTargets // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9909f78
	void KillBots(struct UObject* WorldContextObject, bool bKillPlayers, bool bKillNoneParticipants, char TeamIndex, struct AActor* BotOwner); // Function FortniteAI.AthenaAIBlueprintLibrary.KillBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9909dbc
	void JoinTeam(struct UObject* WorldContextObject, struct AController* SourceTeamController, struct AController* DestinationTeamController); // Function FortniteAI.AthenaAIBlueprintLibrary.JoinTeam // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9909c54
	bool IsWeaponSupported(struct UObject* WorldContextObject, struct AFortWeapon* FortWeapon); // Function FortniteAI.AthenaAIBlueprintLibrary.IsWeaponSupported // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9909ac4
	bool IsItemDefinitionSupported(struct UObject* WorldContextObject, struct UFortItemDefinition* FortItemDef); // Function FortniteAI.AthenaAIBlueprintLibrary.IsItemDefinitionSupported // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9909800
	struct UAthenaAIServicePlayerBots* GetAIServicePlayerBots(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServicePlayerBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908c74
	struct UAthenaAIServiceLoot* GetAIServiceLoot(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServiceLoot // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908ba0
	struct UAthenaAIServiceCreativePlayerBots* GetAIServiceCreativePlayerBots(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServiceCreativePlayerBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908acc
	struct UAthenaAIPopulationTracker* GetAIPopulationTracker(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIPopulationTracker // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908a34
	struct APawn* AthenaSpawnAIFromClass(struct UObject* WorldContextObject, struct APawn* PawnClass, struct UBehaviorTree* BehaviorTree, struct FVector Location, struct FRotator Rotation, bool bNoCollisionFail, struct AActor* Owner); // Function FortniteAI.AthenaAIBlueprintLibrary.AthenaSpawnAIFromClass // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x99085a8
	bool AIPawnFromGAHasLuringPickupAsGoal(struct FGameplayAbilityActorInfo& ActorInfo, struct FGameplayTag GameplayTag, float MaxLifetime, enum class EFortPickupSpawnSource RequiredPickupSpawnSource); // Function FortniteAI.AthenaAIBlueprintLibrary.AIPawnFromGAHasLuringPickupAsGoal // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9908104
};
...
struct AFortAIDirector : AActor {
	...
	void UnregisterPatrolWard(struct TScriptInterface<IFortPatrolWardInterface> PatrolWard); // Function FortniteAI.FortAIDirector.UnregisterPatrolWard // (Final|Native|Public|BlueprintCallable) // @ game+0x99126d0
	struct UFortAIEncounterInfo* StartEncounter(struct FString& EncounterInstigator, struct UFortDifficultyEncounterSettings* DifficultyEncounterSettings, struct FFortAIEncounterQueryData OptionalQueryData); // Function FortniteAI.FortAIDirector.StartEncounter // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99124b4
	void RegisterPatrolWard(struct TScriptInterface<IFortPatrolWardInterface> PatrolWard); // Function FortniteAI.FortAIDirector.RegisterPatrolWard // (Final|Native|Public|BlueprintCallable) // @ game+0x9912424
	void ReceivePawnSpawned(struct AFortPawn* SpawnedPawn); // Function FortniteAI.FortAIDirector.ReceivePawnSpawned // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	void PostDayPhaseChanged(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation); // Function FortniteAI.FortAIDirector.PostDayPhaseChanged // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnRestStarted(); // Function FortniteAI.FortAIDirector.OnRestStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnRampStarted(); // Function FortniteAI.FortAIDirector.OnRampStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnPlayerSpawn(struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.FortAIDirector.OnPlayerSpawn // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnPlayerDied(struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.FortAIDirector.OnPlayerDied // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnPeakStarted(); // Function FortniteAI.FortAIDirector.OnPeakStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnPawnDied(struct AFortAIPawn* KilledPawn); // Function FortniteAI.FortAIDirector.OnPawnDied // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnFadeStarted(); // Function FortniteAI.FortAIDirector.OnFadeStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnDirectorDeactivated(); // Function FortniteAI.FortAIDirector.OnDirectorDeactivated // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnDayPhaseChanged(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation); // Function FortniteAI.FortAIDirector.OnDayPhaseChanged // (Native|Public) // @ game+0x9912324
	bool IsPointTooCloseToPatrolWards(struct FVector& Point, enum class EWardAffectType WardEffectTypeFilter); // Function FortniteAI.FortAIDirector.IsPointTooCloseToPatrolWards // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9912248
	bool IsLineTooCloseToPatrolWards(struct FVector& LineStart, struct FVector& LineEnd); // Function FortniteAI.FortAIDirector.IsLineTooCloseToPatrolWards // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9912158
	bool IsAnyEncounterGoalWithinDistanceOfPoint(struct FVector& Point, float Distance, bool bOnlyActiveEncounters); // Function FortniteAI.FortAIDirector.IsAnyEncounterGoalWithinDistanceOfPoint // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9912050
	bool IsAnyAIRelevantToPlayer(struct AFortPlayerPawn* Player); // Function FortniteAI.FortAIDirector.IsAnyAIRelevantToPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911cc0
	bool IsAnyActiveEncounterRelevantToPlayer(struct AFortPlayerPawn* Player); // Function FortniteAI.FortAIDirector.IsAnyActiveEncounterRelevantToPlayer // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911fac
	bool IsAnyActiveEncounterRelevantToDefender(struct AFortAIPawn* Defender); // Function FortniteAI.FortAIDirector.IsAnyActiveEncounterRelevantToDefender // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911f08
	struct FVector GetVectorFromEncounterDirection(enum class EFortEncounterDirection Direction); // Function FortniteAI.FortAIDirector.GetVectorFromEncounterDirection // (Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x9911c2c
	struct TArray<struct ABuildingRift*> GetRiftsFromClosestActiveEncounterTo(struct AActor* Target); // Function FortniteAI.FortAIDirector.GetRiftsFromClosestActiveEncounterTo // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911ad0
	int32_t GetNumPlayers(); // Function FortniteAI.FortAIDirector.GetNumPlayers // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x75f98d8
	int32_t GetNumActiveEncounters(); // Function FortniteAI.FortAIDirector.GetNumActiveEncounters // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9911ab8
	enum class EFortEncounterDirection GetEncounterDirectionFromVector(struct FVector DirectionVector); // Function FortniteAI.FortAIDirector.GetEncounterDirectionFromVector // (Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x9911a28
	void GetAmbientThreatEncounterSpawnLocations(struct TArray<struct FVector>& AmbientThreatEncounterSpawnLocations); // Function FortniteAI.FortAIDirector.GetAmbientThreatEncounterSpawnLocations // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911968
	void Deactivate(); // Function FortniteAI.FortAIDirector.Deactivate // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x1652184
	struct TArray<enum class EFortEncounterDirection> ConvertInvalidDirectionsToValidDirections(struct TArray<enum class EFortEncounterDirection> InvalidDirections); // Function FortniteAI.FortAIDirector.ConvertInvalidDirectionsToValidDirections // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x9911878
	void Activate(); // Function FortniteAI.FortAIDirector.Activate // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x1f7f8cc
};
...
struct AAthenaAIDirector : AFortAIDirector {
	...
	void AggroOnActor(struct AAthenaAIController* AIController, struct AActor* Target); // Function FortniteAI.AthenaAIDirector.AggroOnActor // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x990c040
};
...
struct UAthenaAIPerceptionStimuliSourceComponent : UAIPerceptionStimuliSourceComponent {
	...
	void OnOwnerTeamIndexChanged(); // Function FortniteAI.AthenaAIPerceptionStimuliSourceComponent.OnOwnerTeamIndexChanged // (Final|Native|Private) // @ game+0x990d284
};
...
struct UAthenaAIPopulationTracker : UAISubsystem {
	...
	void OnFortPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.AthenaAIPopulationTracker.OnFortPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x990cea4
	void OnAISpawned(struct APawn* Pawn, int32_t RequestId); // Function FortniteAI.AthenaAIPopulationTracker.OnAISpawned // (Final|Native|Private) // @ game+0x990cb6c
	void OnAgentGameOver(struct AFortAthenaAIBotController* AIBotController, struct AFortPawn* Pawn, struct AController* Instigator); // Function FortniteAI.AthenaAIPopulationTracker.OnAgentGameOver // (Final|Native|Private) // @ game+0x990cc8c
	int32_t GetNumTotalBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumTotalBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c53c
	int32_t GetNumPlayerBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumPlayerBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9287550
	int32_t GetNumNonAthenaParticipantBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumNonAthenaParticipantBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c528
	int32_t GetNumAIPawn(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumAIPawn // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c514
	struct FAIPopulationCountSnapshot GetAIPopulationTrackerCount(); // Function FortniteAI.AthenaAIPopulationTracker.GetAIPopulationTrackerCount // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c2c0
	struct TArray<struct AController*> GetAIMatchingQuery(struct FGameplayTagQuery& TagQuery); // Function FortniteAI.AthenaAIPopulationTracker.GetAIMatchingQuery // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c17c
};
...
struct UAthenaAIServiceCover : UAthenaAIService {
	...
	struct UAthenaAIServiceCover* GetAthenaAIServiceCover(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIServiceCover.GetAthenaAIServiceCover // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x990c2fc
};
...
struct UAthenaAIServiceLOFOccluder : UAthenaAIService {
	...
	void UnregisterOccluder(struct AActor* OccluderActor); // Function FortniteAI.AthenaAIServiceLOFOccluder.UnregisterOccluder // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990d9fc
	void RegisterOccluder(struct AActor* OccluderActor, float SphereRadius); // Function FortniteAI.AthenaAIServiceLOFOccluder.RegisterOccluder // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990d654
	bool IsLOFOccluded(struct FVector& StartLocation, struct FVector& EndLocation); // Function FortniteAI.AthenaAIServiceLOFOccluder.IsLOFOccluded // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c554
	struct UAthenaAIServiceLOFOccluder* GetAthenaAIServiceLOFOccluder(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIServiceLOFOccluder.GetAthenaAIServiceLOFOccluder // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x990c37c
};
...
struct UAthenaAIServiceLoot : UAthenaAIService {
	...
	void UpdateSupplyDropStatus(); // Function FortniteAI.AthenaAIServiceLoot.UpdateSupplyDropStatus // (Final|Native|Private) // @ game+0x990dbb4
	void UpdateMovingLoots(); // Function FortniteAI.AthenaAIServiceLoot.UpdateMovingLoots // (Final|Native|Private) // @ game+0x990dba0
	void OnGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.AthenaAIServiceLoot.OnGamePhaseStepChanged // (Final|Native|Public|HasOutParms) // @ game+0x990d1a4
	void K2_RemoveGameplayTagFromLoot(struct AActor* LootActor, struct FGameplayTag& GameplayTag); // Function FortniteAI.AthenaAIServiceLoot.K2_RemoveGameplayTagFromLoot // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x990c94c
	void K2_AddGameplayTagToLoot(struct AActor* LootActor, struct FGameplayTag& GameplayTag); // Function FortniteAI.AthenaAIServiceLoot.K2_AddGameplayTagToLoot // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x990c87c
};
...
struct UAthenaAISpawner : UAISubsystem {
	...
	int32_t RequestSpawn(struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList, struct FTransform& SpawnTransform, bool bUrgentRequest); // Function FortniteAI.AthenaAISpawner.RequestSpawn // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990e8b4
	void QueueForDespawn(struct AActor* ActorToDespawn); // Function FortniteAI.AthenaAISpawner.QueueForDespawn // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990e768
	bool CancelRequest(int32_t RequestId); // Function FortniteAI.AthenaAISpawner.CancelRequest // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990dd94
};
...
struct UFortAISystem : UAISystem {
	...
	bool IsInCone2D(struct FVector ConeOrigin, struct FVector ConeDirection, float HalfAngle, struct FVector LocationToCheck); // Function FortniteAI.FortAISystem.IsInCone2D // (Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x991b0cc
};
...
struct UAthenaAISystem : UFortAISystem {
	...
	void OnAIPawnSpawned(struct AController* SpawnedController, bool bIsABot, struct AFortPawn* FortAIPawn, struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.AthenaAISystem.OnAIPawnSpawned // (Final|Native|Protected) // @ game+0x990e610
	void OnAIPawnDied(struct AController* KilledController, bool bIsABot, struct AFortPawn* KilledAIPawn, struct AFortPlayerPawn* KilledPlayerPawn, struct AController* KillerController); // Function FortniteAI.AthenaAISystem.OnAIPawnDied // (Final|Native|Protected) // @ game+0x990e478
	void HandlePlayerExitAircraft(struct AController* ExitingController); // Function FortniteAI.AthenaAISystem.HandlePlayerExitAircraft // (Final|Native|Protected) // @ game+0x990e084
	void HandleGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.AthenaAISystem.HandleGamePhaseStepChanged // (Final|Native|Protected|HasOutParms) // @ game+0x990dfa4
	void AIProfiling_OnSafeZoneUpdated(); // Function FortniteAI.AthenaAISystem.AIProfiling_OnSafeZoneUpdated // (Final|Native|Public) // @ game+0x21ce454
	void AIProfiling_OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.AthenaAISystem.AIProfiling_OnGamePhaseChanged // (Final|Native|Public) // @ game+0x675931c
};
...
struct AAthenaCreativeRift : ABuildingRift {
	...
	void NotifyActorDespawnEndOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function FortniteAI.AthenaCreativeRift.NotifyActorDespawnEndOverlap // (Final|Native|Public) // @ game+0x990e33c
	void BlueprintShowRift(); // Function FortniteAI.AthenaCreativeRift.BlueprintShowRift // (RequiredAPI|Event|Public|BlueprintEvent) // @ game+0xda071c
};
...
struct AAthenaNavInvokerBox : AActor {
	...
	void SetInvokerEnabled(bool bEnable); // Function FortniteAI.AthenaNavInvokerBox.SetInvokerEnabled // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990eac4
};
...
struct AAthenaNavMesh : AFortNavMesh {
	...
	void MoveTiles(struct FBox& SourceBox, struct FIntPoint& TileOffset, float RotationDeg, struct FVector2D& FillerTilePosition); // Function FortniteAI.AthenaNavMesh.MoveTiles // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990e1c8
	void ComputeOffsetForMoveTiles(struct FVector& StartPosition, struct FVector& DesiredPosition, struct FVector& OutEndPosition, struct FIntPoint& OutTileOffset); // Function FortniteAI.AthenaNavMesh.ComputeOffsetForMoveTiles // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990de20
};
...
struct UAthenaNavPresenceDetectorComponent : UActorComponent {
	...
	void OnNavMeshTilesUpdated(struct FUpdatedNavMeshTiles& UpdatedNavMeshTiles); // Function FortniteAI.AthenaNavPresenceDetectorComponent.OnNavMeshTilesUpdated // (Final|Native|Protected|HasOutParms) // @ game+0x5029500
	bool HasValidNavMeshLocation(); // Function FortniteAI.AthenaNavPresenceDetectorComponent.HasValidNavMeshLocation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x50294d0
};
...
struct UFortNavSystem : UNavigationSystemV1 {
	...
	void OnNavDataRegistered(struct ANavigationData* NavData); // Function FortniteAI.FortNavSystem.OnNavDataRegistered // (Final|Native|Protected) // @ game+0x992cde4
	bool IsNavmeshInRadiusInitialized(struct UObject* WorldContext, struct FVector& TestLocation, float TestRadius); // Function FortniteAI.FortNavSystem.IsNavmeshInRadiusInitialized // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x992ca54
};
...
struct UAthenaNavSystem : UFortNavSystem {
	...
	void UnregisterNavGenerationObserver(struct USceneComponent* Component); // Function FortniteAI.AthenaNavSystem.UnregisterNavGenerationObserver // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x990eb44
	void RegisterNavGenerationObserver(struct USceneComponent* Component, struct FDelegate event); // Function FortniteAI.AthenaNavSystem.RegisterNavGenerationObserver // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x990e7e8
	bool IsInitialNavigationLockActive(struct UObject* WorldContextObject); // Function FortniteAI.AthenaNavSystem.IsInitialNavigationLockActive // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x990e104
};
...
struct UDespawnExpiredPawnComponent : UFortPawnComponent {
	...
	struct TArray<struct ABuildingRift*> GetDespawnRifts(); // Function FortniteAI.DespawnExpiredPawnComponent.GetDespawnRifts // (Final|Native|Public|BlueprintCallable) // @ game+0x990f3f8
	void DespawnExpired(); // Function FortniteAI.DespawnExpiredPawnComponent.DespawnExpired // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x750ca60
	void AddDespawnRift(struct ABuildingRift* NewRift); // Function FortniteAI.DespawnExpiredPawnComponent.AddDespawnRift // (Final|Native|Public|BlueprintCallable) // @ game+0x990f138
};
...
struct UFortAIComponent_Voice : UActorComponent {
	...
	void SetVoiceSoundBank(struct UFortTaggedSoundBank* InSoundBank); // Function FortniteAI.FortAIComponent_Voice.SetVoiceSoundBank // (Final|Native|Public|BlueprintCallable) // @ game+0x9910478
	struct UFortTaggedSoundBank* GetVoiceSoundBank(); // Function FortniteAI.FortAIComponent_Voice.GetVoiceSoundBank // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x21e90d4
};
...
struct AFortAIDirectorDataManager : AActor {
	...
	void TriggerEvent(struct FFortAIDirectorEvent& TriggeredEvent); // Function FortniteAI.FortAIDirectorDataManager.TriggerEvent // (Native|Public|HasOutParms) // @ game+0x991494c
	float GetAIDirectorFactorValue(enum class EFortAIDirectorFactor AIDirectorFactor); // Function FortniteAI.FortAIDirectorDataManager.GetAIDirectorFactorValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991363c
};
...
struct UFortAIEncounterInfo : UObject {
	...
	void UnRegisterAISpawner(struct AActor* InAISpawner); // Function FortniteAI.FortAIEncounterInfo.UnRegisterAISpawner // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99149f0
	void SpawnTestAIGroup(struct UFortAISpawnGroup* SpawnGroupToSpawn, struct FVector SpawnLocation, struct FRotator SpawnRotation, struct AActor* SpawnSource, struct TArray<struct UFortAbilitySet*> AbilitySetsToGrantOnSpawn, struct FFortAISpawnGroupUpgradeData UpgradeData, bool bAllowAssigningToExternalSpawners, float SecondsBetweenSpawns); // Function FortniteAI.FortAIEncounterInfo.SpawnTestAIGroup // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9914668
	struct AFortAIPawn* SpawnAIPawnReservedForEnemySpawner(struct AActor* EnemySpawner, struct FVector SpawnLocation, struct FRotator SpawnRotation); // Function FortniteAI.FortAIEncounterInfo.SpawnAIPawnReservedForEnemySpawner // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9914538
	void SetPawnNumberLimit(int32_t InPawnNumberLimit); // Function FortniteAI.FortAIEncounterInfo.SetPawnNumberLimit // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99144bc
	void SetNukeWavesAtEncounterEnd(bool bNuke); // Function FortniteAI.FortAIEncounterInfo.SetNukeWavesAtEncounterEnd // (Final|Native|Public|BlueprintCallable) // @ game+0x991443c
	void SetEncounterActivationState(bool bEncounterActivityState); // Function FortniteAI.FortAIEncounterInfo.SetEncounterActivationState // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99143bc
	void RequestActivation(int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterInfo.RequestActivation // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991433c
	void RegisterAISpawner(struct AActor* InAISpawner); // Function FortniteAI.FortAIEncounterInfo.RegisterAISpawner // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99142bc
	void OnRestStarted(); // Function FortniteAI.FortAIEncounterInfo.OnRestStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnRampStarted(); // Function FortniteAI.FortAIEncounterInfo.OnRampStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnPeakStarted(); // Function FortniteAI.FortAIEncounterInfo.OnPeakStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnGoalTakeDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.OnGoalTakeDamage // (Final|Native|Public|HasDefaults) // @ game+0x9914040
	void OnGameDifficultyChanged(); // Function FortniteAI.FortAIEncounterInfo.OnGameDifficultyChanged // (Final|Native|Private) // @ game+0x991402c
	void OnFadeStarted(); // Function FortniteAI.FortAIEncounterInfo.OnFadeStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnEncounterPawnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.OnEncounterPawnDamaged // (Final|Native|Protected|HasDefaults) // @ game+0x9913db0
	void NotifyRiftDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.NotifyRiftDied // (Final|Native|Public|HasDefaults) // @ game+0x9913b34
	bool GroupHasAIRemainingToSpawn(struct FFortAISpawnerData& FortAISpawnerData); // Function FortniteAI.FortAIEncounterInfo.GroupHasAIRemainingToSpawn // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9913a38
	int32_t GetPawnNumberLimit(); // Function FortniteAI.FortAIEncounterInfo.GetPawnNumberLimit // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913a18
	float GetEncounterTimeSeconds(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterTimeSeconds // (Final|Native|Public|BlueprintCallable) // @ game+0x764352c
	void GetEncounterRifts(struct TArray<struct ABuildingRift*>& OutRifts); // Function FortniteAI.FortAIEncounterInfo.GetEncounterRifts // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x991397c
	struct AActor* GetEncounterQueryActor(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterQueryActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99138f8
	void GetEncounterGameplayTags(struct FGameplayTagContainer& OutEncounterTags); // Function FortniteAI.FortAIEncounterInfo.GetEncounterGameplayTags // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913840
	struct AFortAIDirectorDataManager* GetEncounterDataManager(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterDataManager // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x9913814
	void GetEncounterAssignmentGoalActors(struct TArray<struct AActor*>& OutGoalActors); // Function FortniteAI.FortAIEncounterInfo.GetEncounterAssignmentGoalActors // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913778
	bool GetCurrentSpawnAreaDirections(struct TArray<enum class EFortEncounterDirection>& OutDirections); // Function FortniteAI.FortAIEncounterInfo.GetCurrentSpawnAreaDirections // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x99136cc
	bool EncounterHasReservedSpawnRequestForEnemySpawner(struct AActor* EnemySpawner); // Function FortniteAI.FortAIEncounterInfo.EncounterHasReservedSpawnRequestForEnemySpawner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913500
	void DespawnPendingAndCurrentAI(); // Function FortniteAI.FortAIEncounterInfo.DespawnPendingAndCurrentAI // (Final|Native|Public|BlueprintCallable) // @ game+0x99134c8
	struct UFortAIAssignment* CreateEncounterAssignment(struct UFortAIAssignmentSettings* AssignmentSettings, struct AActor* GoalActor); // Function FortniteAI.FortAIEncounterInfo.CreateEncounterAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9913404
};
...
struct UFortAIEncounterInfoOwnerInterface : UInterface {
	...
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIEncounterInfoOwnerInterface.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x208c02c
};
...
struct UFortAIEncounterRiftManager : UObject {
	...
	void OnRiftDestroyed(struct AActor* Rift); // Function FortniteAI.FortAIEncounterRiftManager.OnRiftDestroyed // (Final|Native|Public) // @ game+0x5029c10
	struct AFortMission* GetAssociatedMission(); // Function FortniteAI.FortAIEncounterRiftManager.GetAssociatedMission // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9916118
};
...
struct UFortAIEncounterSequence : UObject {
	...
	void StopCurrentEncounter(); // Function FortniteAI.FortAIEncounterSequence.StopCurrentEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99181f4
	struct UFortAIEncounterInfo* StartCurrentEncounterWithSavedData(enum class EFortEncounterSequenceResult& OutRequestResult, int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterSequence.StartCurrentEncounterWithSavedData // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9918118
	struct UFortAIEncounterInfo* StartCurrentEncounter(enum class EFortEncounterSequenceResult& OutRequestResult, struct TArray<struct AActor*>& InTargetActors, struct UFortAIAssignmentSettings* InAssignmentSettings, struct FEncounterEnvironmentQueryInfo InOverrideEnvironmentQueryInfo, struct AActor* InOptionalQueryActor, struct FGameplayTagContainer InInjectedTags, struct FFortEncounterSettings InEncounterSettings, int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterSequence.StartCurrentEncounter // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9917dcc
	void SetEncounterStartingData(struct TArray<struct AActor*>& InTargetActors, struct UFortAIAssignmentSettings* InAssignmentSettings, struct FEncounterEnvironmentQueryInfo InOverrideEnvironmentQueryInfo, struct AActor* InOptionalQueryActor, struct FGameplayTagContainer InInjectedTags, struct FFortEncounterSettings InEncounterSettings); // Function FortniteAI.FortAIEncounterSequence.SetEncounterStartingData // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9917b14
	enum class EFortEncounterSequenceResult Previous(); // Function FortniteAI.FortAIEncounterSequence.Previous // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9917584
	enum class EFortEncounterSequenceResult Next(); // Function FortniteAI.FortAIEncounterSequence.Next // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9917560
	enum class EFortEncounterSequenceResult Last(); // Function FortniteAI.FortAIEncounterSequence.Last // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99164fc
	bool IsOnFinalIndexInSequence(); // Function FortniteAI.FortAIEncounterSequence.IsOnFinalIndexInSequence // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99164e0
	bool HasEncounter(); // Function FortniteAI.FortAIEncounterSequence.HasEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9916354
	int32_t GetNumEncountersInSequence(); // Function FortniteAI.FortAIEncounterSequence.GetNumEncountersInSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7341cd4
	int32_t GetEncounterIndexInSequence(); // Function FortniteAI.FortAIEncounterSequence.GetEncounterIndexInSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d618
	struct UFortAIEncounterInfo* GetCurrentEncounter(); // Function FortniteAI.FortAIEncounterSequence.GetCurrentEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68f8b68
	bool EncounterBelongsToSequence(struct UFortAIEncounterInfo* InEncounter); // Function FortniteAI.FortAIEncounterSequence.EncounterBelongsToSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9915ff4
};
...
struct UFortAIEncounterTargetInterface : UInterface {
	...
	bool IsFloatingTarget(); // Function FortniteAI.FortAIEncounterTargetInterface.IsFloatingTarget // (Event|Public|BlueprintEvent) // @ game+0xda071c
	float GetObjectiveCompletionPercentage(); // Function FortniteAI.FortAIEncounterTargetInterface.GetObjectiveCompletionPercentage // (Event|Public|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortAIEnvironmentalDangerSourceInterface : UInterface {
	...
	struct FBox GetDangerSourceBounds(); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerSourceBounds // (Native|Event|Public|HasDefaults|BlueprintEvent|Const) // @ game+0x9916208
	bool GetDangerSourceActive(); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerSourceActive // (Native|Event|Public|BlueprintEvent|Const) // @ game+0x740e2c0
	float GetDangerAtLocation(struct FVector& Location); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerAtLocation // (Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const) // @ game+0x9916170
};
...
struct UFortAIFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool TeleportAIPawn(struct AFortAIPawn* AIPawn, struct FVector DestLocation, struct FRotator DestRotation, bool bIgnoreCollision); // Function FortniteAI.FortAIFunctionLibrary.TeleportAIPawn // (Final|BlueprintAuthorityOnly|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x9918208
	void SetHearingRange(struct AActor* AIAgent, float Range); // Function FortniteAI.FortAIFunctionLibrary.SetHearingRange // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x75d6938
	void RequestNavUpdateForBuilding(struct ABuildingActor* BuildingActor); // Function FortniteAI.FortAIFunctionLibrary.RequestNavUpdateForBuilding // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x99179e0
	void MakeNoiseEventAtLocation(struct AActor* NoiseMaker, float MaxRange, struct FVector& NoiseLocation, struct FName NoiseTag); // Function FortniteAI.FortAIFunctionLibrary.MakeNoiseEventAtLocation // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9917274
	void MakeNoiseEvent(struct AActor* NoiseMaker, float MaxRange, struct FName NoiseTag); // Function FortniteAI.FortAIFunctionLibrary.MakeNoiseEvent // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9916f7c
	bool IsConcealedByPerceptionModifiers(struct UObject* WorldContextObject, struct FVector ObserverLocation, struct FVector TargetLocation, float& OutConcealment); // Function FortniteAI.FortAIFunctionLibrary.IsConcealedByPerceptionModifiers // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9916370
	struct UFortAthenaAIRuntimeParameters* GetOrCreateAIRuntimeParameters(struct AAIController* AIController, struct UFortAthenaAIRuntimeParameters* ParametersClass); // Function FortniteAI.FortAIFunctionLibrary.GetOrCreateAIRuntimeParameters // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9916250
	struct UAthenaAISpawner* GetAISpawner(struct UObject* WorldContextObject); // Function FortniteAI.FortAIFunctionLibrary.GetAISpawner // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9916080
};
...
struct AFortAIGoalManager : AActor {
	...
	void SetCurrentGoalDiscouragement(struct UObject* WorldContext, struct AFortAIController* AI); // Function FortniteAI.FortAIGoalManager.SetCurrentGoalDiscouragement // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9917a64
	void RemoveWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier AssignmentIdentifier); // Function FortniteAI.FortAIGoalManager.RemoveWorldAssignment // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x99178f8
	void RemoveGoalsFromWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct TArray<struct FFortAIGoalInfo>& GoalInfos); // Function FortniteAI.FortAIGoalManager.RemoveGoalsFromWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99176f8
	void RemoveGoalFromWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct FFortAIGoalInfo& GoalInfo); // Function FortniteAI.FortAIGoalManager.RemoveGoalFromWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99175a8
	void MakeGoalsFromLocationsAndActor(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct FVector>& GoalLocations, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromLocationsAndActor // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9916d3c
	void MakeGoalsFromLocations(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct FVector>& GoalLocations); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromLocations // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9916b38
	void MakeGoalsFromActors(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct AActor*>& GoalActors, bool bActorsAlwaysPerceived, bool bGoalActorsAllowUndermining); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromActors // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99168b8
	void MakeGoalFromLocation(struct FFortAIGoalInfo& Goal, struct UObject* WorldContextObject, struct FVector& GoalLocation); // Function FortniteAI.FortAIGoalManager.MakeGoalFromLocation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9916750
	void MakeGoalFromActor(struct FFortAIGoalInfo& Goal, struct UObject* WorldContextObject, struct AActor* GoalActor, bool bActorAlwaysPerceived, bool bGoalActorAllowsUndermining); // Function FortniteAI.FortAIGoalManager.MakeGoalFromActor // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9916520
	void CreateWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier WorldAssignmentIdentifier, struct UFortAIAssignmentSettings* AssignmentSettings, struct UFortAIGoalProvider* GoalProvider, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, enum class EAssignmentCreationResult& CreationResult); // Function FortniteAI.FortAIGoalManager.CreateWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9915de0
	struct UFortAIAssignment* AddWorldAssignment(struct UFortAIAssignmentSettings* AssignmentSettings, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.AddWorldAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9915d1c
	void AddGoalToWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct FFortAIGoalInfo& GoalInfo); // Function FortniteAI.FortAIGoalManager.AddGoalToWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99159cc
	void AddGoalsToWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct TArray<struct FFortAIGoalInfo>& GoalInfos); // Function FortniteAI.FortAIGoalManager.AddGoalsToWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9915b1c
	void AddGoalActorToAssignment(struct UFortAIAssignment* Assignment, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.AddGoalActorToAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9915780
	void AddGoal(struct AActor* GoalActor, struct UFortAIAssignmentSettings* GoalSettings); // Function FortniteAI.FortAIGoalManager.AddGoal // (Final|Native|Public|BlueprintCallable) // @ game+0x99156b8
};
...
struct UFortAIGoalProvider : UObject {
	...
	void UpdateGoals(); // Function FortniteAI.FortAIGoalProvider.UpdateGoals // (Native|Public|BlueprintCallable) // @ game+0x6859d3c
	bool InitializeGoalProvider(struct UWorld* ContextWorld, struct UFortAIAssignment* Assignment); // Function FortniteAI.FortAIGoalProvider.InitializeGoalProvider // (Native|Public|BlueprintCallable) // @ game+0x9918b88
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIGoalProvider.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918854
};
...
struct UFortAIManagerMinigameComponent : UActorComponent {
	...
	void OnPawnSpawned(struct APawn* Pawn, int32_t RequestId); // Function FortniteAI.FortAIManagerMinigameComponent.OnPawnSpawned // (Final|Native|Public) // @ game+0x9918f00
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIManagerMinigameComponent.OnPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9918c84
	void HandleMinigameStarted(); // Function FortniteAI.FortAIManagerMinigameComponent.HandleMinigameStarted // (Final|Native|Public) // @ game+0x9918950
};
...
struct UFortAIRootAssignmentProviderInterface : UInterface {
	...
	struct FFortAIAssignmentIdentifier GetRootAssignmentIdentifier(); // Function FortniteAI.FortAIRootAssignmentProviderInterface.GetRootAssignmentIdentifier // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918908
};
...
struct UFortAISpawnerInterface : UInterface {
	...
	bool OnReceiveSpawnGroup(); // Function FortniteAI.FortAISpawnerInterface.OnReceiveSpawnGroup // (Event|Public|BlueprintEvent) // @ game+0xda071c
	bool IsReadyToReceiveNewSpawnGroup(); // Function FortniteAI.FortAISpawnerInterface.IsReadyToReceiveNewSpawnGroup // (Event|Public|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortAISpawnerUtilityComponent : UActorComponent {
	...
	void StartEnvironmentQuery(); // Function FortniteAI.FortAISpawnerUtilityComponent.StartEnvironmentQuery // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x99195fc
	void SetQueryRadius(float Radius); // Function FortniteAI.FortAISpawnerUtilityComponent.SetQueryRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9919578
	void SetMinigame(struct AFortMinigame* Minigame); // Function FortniteAI.FortAISpawnerUtilityComponent.SetMinigame // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x99194ec
	void SetEQSQuery(struct TSoftObjectPtr<UEnvQuery> SelectedEQSQuery); // Function FortniteAI.FortAISpawnerUtilityComponent.SetEQSQuery // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x991942c
	int32_t RequestSpawn(struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList, struct FTransform& SpawnTransform); // Function FortniteAI.FortAISpawnerUtilityComponent.RequestSpawn // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991930c
	void OnUnownedPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAISpawnerUtilityComponent.OnUnownedPawnDied // (Final|Native|Private|HasDefaults) // @ game+0x9918fc4
	bool IsSpawnCountCapped(); // Function FortniteAI.FortAISpawnerUtilityComponent.IsSpawnCountCapped // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1feae90
	void HandleUnownedPawnSpawned(struct AFortPawn* FortPawn); // Function FortniteAI.FortAISpawnerUtilityComponent.HandleUnownedPawnSpawned // (Final|Native|Public|BlueprintCallable) // @ game+0x9918964
};
...
struct UFortAISpawnGroup : UPrimaryDataAsset {
	...
	bool IsValidForEnemySpawners(); // Function FortniteAI.FortAISpawnGroup.IsValidForEnemySpawners // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1f9b6dc
	bool IsPrototype(); // Function FortniteAI.FortAISpawnGroup.IsPrototype // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918c6c
	bool IsLargeSpawnGroup(); // Function FortniteAI.FortAISpawnGroup.IsLargeSpawnGroup // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918c54
	int32_t GetNumberOfEnemies(); // Function FortniteAI.FortAISpawnGroup.GetNumberOfEnemies // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68f8bb8
	struct UFortAIPawnVariant* GetEnemy(int32_t EnemyIndex); // Function FortniteAI.FortAISpawnGroup.GetEnemy // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918880
};
...
struct UFortAITetheringBoxBoundsInterface : UInterface {
	...
	float GetTetheredBoxBoundsWidth(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsWidth // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	float GetTetheredBoxBoundsHeight(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsHeight // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	float GetTetheredBoxBoundsEQSSpaceBetween(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsEQSSpaceBetween // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	float GetTetheredBoxBoundsEQSGridSize(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsEQSGridSize // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda071c
	struct FVector GetTetheredBoxBoundsCenter(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsCenter // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|HasDefaults|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortAthenaAIBotCosmeticData : UDataAsset {
	...
	struct TSoftObjectPtr<UFortAthenaAIBotCosmeticLibraryData> FindLibraryDataFromName(struct FString PartialName); // Function FortniteAI.FortAthenaAIBotCosmeticData.FindLibraryDataFromName // (Final|Native|Public|BlueprintCallable) // @ game+0x991e814
};
...
struct UFortAthenaAIBotCosmeticLibraryData : UPrimaryDataAsset {
	...
	struct TArray<struct UDataTable*> RetrieveDataTables(); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.RetrieveDataTables // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991f3d8
	struct UDataTable* FindDataTableFromAssetType(struct FString AssetType); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.FindDataTableFromAssetType // (Final|Native|Public|BlueprintCallable) // @ game+0x991e6b0
	bool FillDataTableValuesFromSourceLibrary(struct UFortAthenaAIBotCosmeticLibraryData* SourceLibrary); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.FillDataTableValuesFromSourceLibrary // (Final|Native|Public|BlueprintCallable) // @ game+0x991e518
};
...
struct UBotCosmeticBlueprintHelperLibrary : UBlueprintFunctionLibrary {
	...
	bool SplitDataArrayByType(struct TArray<struct FString>& InAssetNames, struct TArray<struct FString>& InAssetTypes, struct TArray<int32_t>& InAssetUsageCounts, struct TArray<int32_t>& InAssetTypeSplitIndices, int32_t CurrentSplitIndex, struct FString& OutAssetType, struct TArray<struct FString>& OutAssetNames, struct TArray<int32_t>& OutAssetUsageCounts); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.SplitDataArrayByType // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x991f4dc
	struct TArray<struct FString> OpenCSVFileDialog(struct FString TitleDetails, bool bAllowMultipleFiles); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.OpenCSVFileDialog // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x991f230
	bool LoadDataFromCSV(struct FString FilePath, struct TArray<struct FString>& ForbiddenAssetNames, struct TArray<struct FString>& ForbiddenAssetPrefix, struct TArray<struct FString>& AssetNames, struct TArray<struct FString>& AssetTypes, struct TArray<int32_t>& AssetUsageCounts, struct TArray<int32_t>& AssetTypeSplitIndices); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.LoadDataFromCSV // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x991ed90
	bool GenerateWeightedCSV(struct FString AssetTypeName, struct TArray<struct FString>& AssetNames, struct TArray<int32_t>& AssetWeight, struct FString& CSV); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.GenerateWeightedCSV // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x991e9e0
	bool ExportDataTableToSourceCSV(struct UDataTable* DataTable, bool bCanCheckOutFile); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.ExportDataTableToSourceCSV // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x991e46c
};
...
struct UFortAthenaAIBotCustomizationData : UPrimaryDataAsset {
	...
	void SetCharacterCustomizationFromPlayerPawn(struct AFortPlayerPawn* InFortPawn); // Function FortniteAI.FortAthenaAIBotCustomizationData.SetCharacterCustomizationFromPlayerPawn // (Final|Native|Public|BlueprintCallable) // @ game+0x991f44c
};
...
struct UFortAthenaAIBotEvaluator_Movement : UFortAthenaAIBotEvaluator {
	...
	void OnCurrentUnstuckSteeringAttemptFinished(enum class EBotUnstuckSteeringReason UnstuckSteeringReason); // Function FortniteAI.FortAthenaAIBotEvaluator_Movement.OnCurrentUnstuckSteeringAttemptFinished // (Final|Native|Private) // @ game+0x991faa8
	void EvaluateIsolatedIslandSteering(); // Function FortniteAI.FortAthenaAIBotEvaluator_Movement.EvaluateIsolatedIslandSteering // (Final|Native|Private) // @ game+0x991f9b8
};
...
struct UFortAthenaAIBotEvaluator_Converted : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnUnconvertedEvent(struct AFortPawn* UnconvertedPawn, enum class EUnconvertReason UnconvertReason); // Function FortniteAI.FortAthenaAIBotEvaluator_Converted.OnUnconvertedEvent // (Final|Native|Protected) // @ game+0x991f17c
	void OnConvertedEvent(struct AFortPawn* InstigatorPawn, struct AFortPawn* ConvertedPawn); // Function FortniteAI.FortAthenaAIBotEvaluator_Converted.OnConvertedEvent // (Final|Native|Protected) // @ game+0x991f0bc
};
...
struct UFortAthenaAIBotEvaluator_DBNO : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnAllyPawnDBNOStateChanged(struct AFortPawn* InPlayer, bool bInIsDBNO); // Function FortniteAI.FortAthenaAIBotEvaluator_DBNO.OnAllyPawnDBNOStateChanged // (Final|Native|Private) // @ game+0x991f9e0
};
...
struct UFortAthenaAIBotEvaluator_EvasiveManeuvers : UFortAthenaAIBotEvaluator {
	...
	void OnMoveCompleted(struct FAIRequestID RequestId, enum class EPathFollowingResult MovementResult); // Function FortniteAI.FortAthenaAIBotEvaluator_EvasiveManeuvers.OnMoveCompleted // (Final|Native|Public) // @ game+0x991fb28
};
...
struct UFortAthenaAIBotEvaluator_Heal : UFortAthenaAIBotEvaluator {
	...
	void HandlePlayerHealthOrShieldChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Heal.HandlePlayerHealthOrShieldChanged // (Final|Native|Private) // @ game+0x991f9cc
};
...
struct UFortAthenaAIBotEvaluator_Retreat : UFortAthenaAIBotEvaluator_Movement {
	...
	void HandlePlayerHealthOrShieldChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Retreat.HandlePlayerHealthOrShieldChanged // (Final|Native|Protected) // @ game+0x991fbec
};
...
struct UFortAthenaAIBotEvaluator_SandTunnel : UFortAthenaAIBotEvaluator_TagQuery {
	...
	void OnBotControllerAlertLevelChanged(struct AFortAthenaAIBotController* BotController, enum class EAlertLevel OldAlertLevel, enum class EAlertLevel NewAlertLevel); // Function FortniteAI.FortAthenaAIBotEvaluator_SandTunnel.OnBotControllerAlertLevelChanged // (Final|Native|Private) // @ game+0x991fc14
	void Jump(); // Function FortniteAI.FortAthenaAIBotEvaluator_SandTunnel.Jump // (Final|Native|Protected) // @ game+0x991fc00
};
...
struct UFortAthenaAIBotEvaluator_Storm : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnSafezoneStateChanged(enum class EFortSafeZoneState NewState); // Function FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafezoneStateChanged // (Final|Native|Public) // @ game+0x991fd2c
	void OnSafeZonePhaseChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafeZonePhaseChanged // (Final|Native|Public) // @ game+0x991fd18
};
...
struct UFortAthenaAIBotPathFollowingComponent : UFortPathFollowingComponentBase {
	...
	void HandlePawnTeleported(struct AFortPawn* TeleportedPawn); // Function FortniteAI.FortAthenaAIBotPathFollowingComponent.HandlePawnTeleported // (Final|Native|Public) // @ game+0x9921a94
};
...
struct UFortAthenaAISpawnerData : UFortAthenaSpawnerDataBase {
	...
	struct UFortAthenaAISpawnerDataComponent_VoiceBase* GetVoiceComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetVoiceComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9925238
	struct UFortAthenaAISpawnerDataComponent_SpawnParamsBase* GetSpawnParamsComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetSpawnParamsComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99250c0
	struct UFortAthenaAISpawnerDataComponent_SmartObjectBase* GetSmartObjectComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetSmartObjectComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9925084
	struct UFortAthenaAISpawnerDataComponent_ScriptBase* GetScriptComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetScriptComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9925048
	struct UFortAthenaAISpawnerDataComponent_PerceptionBase* GetPerceptionComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetPerceptionComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992500c
	struct UFortAthenaAISpawnerDataComponent_OptimBase* GetOptimizationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetOptimizationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924f0c
	struct UFortAthenaAISpawnerDataComponent_InventoryBase* GetInventoryComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetInventoryComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924e60
	struct UFortAthenaAISpawnerDataComponent_GroupBase* GetGroupComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGroupComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924e24
	struct UFortAthenaAISpawnerDataComponent_GameplayBase* GetGameplayComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGameplayComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924de8
	struct UFortAthenaAISpawnerDataComponent_GameplayAbilityBase* GetGameplayAbilityComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGameplayAbilityComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924dac
	struct UFortAthenaAISpawnerDataComponent_DebugBase* GetDebugComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetDebugComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924d54
	struct UFortAthenaAISpawnerDataComponent_CosmeticBase* GetCosmeticComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetCosmeticComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924d18
	struct UFortAthenaAISpawnerDataComponent_ConversationBase* GetConversationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetConversationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924cdc
	struct UFortAthenaAISpawnerDataComponent_ChanceEncounterBase* GetChanceEncounterComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetChanceEncounterComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924ca0
	struct UFortAthenaAISpawnerDataComponent_BehaviorBase* GetBehaviorComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetBehaviorComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924c68
	struct UFortAthenaAISpawnerDataComponent_AnalyticBase* GetAnalyticComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAnalyticComponent // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6c1c7d8
	struct UFortAthenaAISpawnerDataComponent_LODBase* GetAILODComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAILODComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924bdc
	struct UFortAthenaAISpawnerDataComponent_AffiliationBase* GetAffiliationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAffiliationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924c14
	struct UFortAthenaAISpawnerDataComponentList* CreateComponentListFromClass(struct UFortAthenaAISpawnerData* AISpawnerDataClass, struct UObject* OuterObject); // Function FortniteAI.FortAthenaAISpawnerData.CreateComponentListFromClass // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9924910
	struct UFortAthenaAISpawnerDataComponentList* CreateComponentList(struct UObject* OuterObject); // Function FortniteAI.FortAthenaAISpawnerData.CreateComponentList // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924880
};
...
struct UFortAthenaAIBotSpawnerData : UFortAthenaAISpawnerData {
	...
	struct UFortAthenaAISpawnerDataComponent_VehicleBase* GetVehicleComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetVehicleComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9922374
	struct UFortAthenaAISpawnerDataComponent_SkillsetBase* GetSkillSetComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetSkillSetComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9922338
	struct UFortAthenaAISpawnerDataComponent_PerksBase* GetPerksComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetPerksComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99222fc
	struct UFortAthenaAISpawnerDataComponent_CoverBase* GetCoverComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetCoverComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99222c0
	struct UFortAthenaAISpawnerDataComponent_ConstructionBase* GetConstructionComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetConstructionComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9922284
};
...
struct UFortAthenaAIEvaluator_DormantUntilPhase : UFortAthenaAIEvaluator {
	...
	void HandleGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.FortAthenaAIEvaluator_DormantUntilPhase.HandleGamePhaseStepChanged // (Final|Native|Private|HasOutParms) // @ game+0x99223b0
};
...
struct UFortAthenaAILODComponent : UActorComponent {
	...
	void OnRep_CurrentFortAILODLevel(); // Function FortniteAI.FortAthenaAILODComponent.OnRep_CurrentFortAILODLevel // (Final|Native|Private) // @ game+0x208533c
};
...
struct UFortAthenaAISpawnerDataComponentList : UObject {
	...
	struct UFortAthenaAISpawnerDataComponentList* OverrideComponentClass(struct UFortAthenaAISpawnerDataComponent* NewComponentSubClass); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.OverrideComponentClass // (Final|Native|Public|BlueprintCallable) // @ game+0x9925424
	struct UFortAthenaAISpawnerDataComponentList* OverrideComponent(struct UFortAthenaAISpawnerDataComponent* NewComponent); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.OverrideComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9925394
	struct UFortAthenaAISpawnerDataComponent* GetOrCreateComponentClassForModification(struct UObject* ComponentOuter, struct UFortAthenaAISpawnerDataComponent* ClassToClone); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.GetOrCreateComponentClassForModification // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924f48
	struct TArray<struct UFortAthenaAISpawnerDataComponent*> GetList(); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.GetList // (Final|Native|Public|BlueprintCallable) // @ game+0x9924e98
};
...
struct UFortAthenaAISpawnerDataComponent_AffiliationBase : UFortAthenaAISpawnerDataComponent {
	...
	void SetFullTeamAwarenessPropagationDistance(float InFullTeamAwarenessMaxDistance); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFullTeamAwarenessPropagationDistance // (Final|Native|Public|BlueprintCallable) // @ game+0x99256a8
	void SetFullTeamAwarenessPropagation(bool bInFullTeamAwarenessPropagation); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFullTeamAwarenessPropagation // (Final|Native|Public|BlueprintCallable) // @ game+0x9925624
	void SetFactionTags(struct FGameplayTagContainer& NewTags); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFactionTags // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9925568
	void SetAwarenessPropagationIsBasedOnAlertLevel(bool bInAwarenessPropagationIsBasedOnAlertLevel); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetAwarenessPropagationIsBasedOnAlertLevel // (Final|Native|Public|BlueprintCallable) // @ game+0x99254dc
	bool GetFullTeamAwarenessPropagation(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFullTeamAwarenessPropagation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924d90
	float GetFullTeamAwarenessMaxDistance(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFullTeamAwarenessMaxDistance // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7424714
	struct FGameplayTagContainer GetFactionTag(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFactionTag // (Final|Native|Public|BlueprintCallable) // @ game+0x68f8bcc
	bool GetAwarenessPropagationIsBasedOnAlertLevel(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetAwarenessPropagationIsBasedOnAlertLevel // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924c4c
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotAffiliation : UFortAthenaAISpawnerDataComponent_AffiliationBase {
	...
	void SetOverrideTeamIndex(int32_t InOverrideTeamIdx); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.SetOverrideTeamIndex // (Final|Native|Public|BlueprintCallable) // @ game+0x992572c
	bool GetTeamID(int32_t& OutTeamId); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetTeamID // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9925198
	bool GetSquadID(int32_t& OutSquadId); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetSquadID // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x99250f8
};
...
struct UFortAthenaAIRuntimeParameters_BehaviorTreeControl : UFortAthenaAIRuntimeParameters {
	...
	bool IsBehaviorTreeBranchActive(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.IsBehaviorTreeBranchActive // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9925274
	void EnableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.EnableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9924adc
	void DisableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.DisableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x99249d4
};
...
struct UFortAthenaAISpawnerDataComponent_BehaviorBase : UFortAthenaAISpawnerDataComponent {
	...
	struct UBehaviorTree* GetBehaviorTree(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_BehaviorBase.GetBehaviorTree // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9926dbc
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotBehavior : UFortAthenaAISpawnerDataComponent_Behavior {
	...
	bool IsBehaviorTreeBranchActive(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.IsBehaviorTreeBranchActive // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9925304
	void EnableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.EnableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9924b5c
	void DisableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.DisableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9924a58
};
...
struct UFortAthenaAISpawnerDataComponent_ConstructionBase : UFortAthenaAISpawnerDataComponent {
	...
	bool GetConstructionBuildingInfo(struct FConstructionBuildingList& OutConstructionInfoList); // Function FortniteAI.FortAthenaAISpawnerDataComponent_ConstructionBase.GetConstructionBuildingInfo // (Native|Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0x9926e0c
};
...
struct UFortAthenaAISpawnerDataComponent_CosmeticBase : UFortAthenaAISpawnerDataComponent {
	...
	void GetFallbackTag(struct FGameplayTag& OutFallbackTag); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticBase.GetFallbackTag // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9926ee0
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase : UFortAthenaAISpawnerDataComponent_CosmeticBase {
	...
	void GetLoadout(struct FFortAthenaLoadout& OutLoadout); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetLoadout // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925fbc
	void GetDances(struct TArray<struct UAthenaDanceItemDefinition*>& Dances, struct AFortAthenaAIBotController* BotController); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetDances // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925e0c
	void GetCustomCharacterParts(struct TArray<struct UCustomCharacterPart*>& OutCustomCharacterParts); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetCustomCharacterParts // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925d6c
	void GetAnimBPOverride(struct UAnimInstance*& OutAnimBPOverride, int32_t& OutPriority); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetAnimBPOverride // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925c8c
	void GetAllLoadouts(struct TArray<struct FFortAthenaLoadout>& OutLoadouts); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetAllLoadouts // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925bf0
};
...
struct UFortAthenaAIRuntimeParameters_AIConvert : UFortAthenaAIRuntimeParameters {
	...
	void SetForceKillWhenUnconverted(bool bInForceKillWhenUnconverted); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetForceKillWhenUnconverted // (Final|Native|Public|BlueprintCallable) // @ game+0x992738c
	void SetForceKillWhenConverterDies(bool bInForceKillWhenConverterDies); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetForceKillWhenConverterDies // (Final|Native|Public|BlueprintCallable) // @ game+0x9927310
	void SetCanBeConvertedFromDBNO(bool bInCanBeConvertedFromDBNO); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetCanBeConvertedFromDBNO // (Final|Native|Public|BlueprintCallable) // @ game+0x99271e0
	void SetCanBeConverted(bool bInCanBeConverted); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetCanBeConverted // (Final|Native|Public|BlueprintCallable) // @ game+0x99270bc
	bool GetForceKillWhenUnconverted(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetForceKillWhenUnconverted // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926f84
	bool GetForceKillWhenConverterDies(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetForceKillWhenConverterDies // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926f70
	bool GetCanBeConvertedFromDBNO(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetCanBeConvertedFromDBNO // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926df8
	bool GetCanBeConverted(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetCanBeConverted // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926de4
};
...
struct UFortAthenaAISpawnerDataComponent_GameplayBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldOverrideGlobalSpeedMultiplier(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.ShouldOverrideGlobalSpeedMultiplier // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x757f598
	void SetCopyConverterSpecificRelations(bool bInCopyConverterSpecificRelations); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCopyConverterSpecificRelations // (Final|Native|Public|BlueprintCallable) // @ game+0x992725c
	void SetCanBeConverted(bool bInCanBeConverted); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCanBeConverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9927138
	void PostOnSpawnedBP(struct APawn* PawnAI); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.PostOnSpawnedBP // (Event|Public|BlueprintEvent|Const) // @ game+0xda071c
	float GetGlobalSpeedMultiplier(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.GetGlobalSpeedMultiplier // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926f98
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotGameplay : UFortAthenaAISpawnerDataComponent_GameplayBase {
	...
	void SetNameSettings(enum class EBotNamingMode InNamingMode, struct FString InName, bool bInAddPlayerIDSuffix); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetNameSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x9926334
	void SetLeashOuterRadius(float InLeashOuterRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashOuterRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x99262b0
	void SetLeashLocation(struct FVector InLeashLocation); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashLocation // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9926228
	void SetLeashInnerRadius(float InLeashInnerRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashInnerRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x99261a4
	void SetAssociatedPatrolPath(struct AFortAthenaPatrolPath* InAssociatedPatrolPath); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetAssociatedPatrolPath // (Final|Native|Public|BlueprintCallable) // @ game+0x9926084
};
...
struct UFortAthenaAISpawnerDataComponent_GameplayAbilityBase : UFortAthenaAISpawnerDataComponent {
	...
	void SetLooseTagsToApplyToPawn(struct FGameplayTagContainer& InGameplayTagContainer); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.SetLooseTagsToApplyToPawn // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9927408
	struct FGameplayTagContainer GetLooseTagsToApplyToPawn(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetLooseTagsToApplyToPawn // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9927064
	void GetInitialGameplayEffects(struct TArray<struct FInitialGameplayEffectInfo>& OutGEs); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetInitialGameplayEffects // (Native|Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926104
	void GetInitialGameplayAbilities(struct TArray<struct UFortAbilitySet*>& OutGASets); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetInitialGameplayAbilities // (Native|Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926fc4
};
...
struct UFortAthenaAISpawnerDataComponent_InventoryBase : UFortAthenaAISpawnerDataComponent {
	...
	void GetInventoryItems(struct TArray<struct FItemAndCount>& OutList); // Function FortniteAI.FortAthenaAISpawnerDataComponent_InventoryBase.GetInventoryItems // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9926fc4
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotInventory : UFortAthenaAISpawnerDataComponent_InventoryBase {
	...
	void SetInventoryItems(struct TArray<struct FItemAndCount>& InItems); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotInventory.SetInventoryItems // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9926104
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotPerception : UFortAthenaAISpawnerDataComponent_PerceptionBase {
	...
	void SetVisibilityRange(float InSightRadius, float LoseSightRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotPerception.SetVisibilityRange // (Final|Native|Public|BlueprintCallable) // @ game+0x99265b4
};
...
struct UFortAthenaAISpawnerDataComponent_SkillsetBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldUseMatchMMRToOverrideSkillLevel(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.ShouldUseMatchMMRToOverrideSkillLevel // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x757f598
	struct TArray<struct UFortAthenaAIBotSkillSet*> GetSkillSets(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.GetSkillSets // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9928078
	float GetSkill(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.GetSkill // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9927fe8
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotSkillset : UFortAthenaAISpawnerDataComponent_SkillsetBase {
	...
	void SetSkill(float InSKill); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotSkillset.SetSkill // (Final|Native|Public|BlueprintCallable) // @ game+0x9926530
};
...
struct UFortAthenaAISpawnerDataComponent_CosmeticLibrary : UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase {
	...
	int32_t GetAICosmeticLibraryDataIndex(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryDataIndex // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926d94
	struct UFortAthenaAIBotCosmeticLibraryData* GetAICosmeticLibraryData(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryData // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926d6c
};
...
struct UFortAthenaAISpawnerDataComponent_LODBase : UFortAthenaAISpawnerDataComponent {
	...
	struct FClientAILODSettings GetClientAILODSettings(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_LODBase.GetClientAILODSettings // (RequiredAPI|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9927f5c
	struct UFortAthenaAILODSettingsContainer* GetAILODSettingsContainer(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_LODBase.GetAILODSettingsContainer // (Native|Event|Public|BlueprintEvent|Const) // @ game+0x20172f0
};
...
struct UFortAthenaAISpawnerDataComponent_SpawnParamsBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldSpawnInAir(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.ShouldSpawnInAir // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x7580270
	bool ShouldCheckForOverlaps(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.ShouldCheckForOverlaps // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9928398
	float GetSpawnTracePadding(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetSpawnTracePadding // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x99280f0
	struct TArray<struct UFortAthenaAISpawnerData*> GetSpawnerDataSpawnedAsChildren(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetSpawnerDataSpawnedAsChildren // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x992811c
	struct FDataTableRowHandle GetPawnStatHandle(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetPawnStatHandle // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9928044
	struct APawn* GetPawnClass(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetPawnClass // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9928014
	float GetInAirSpawnTraceStartHeight(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceStartHeight // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927fe8
	float GetInAirSpawnTraceSphereRadius(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceSphereRadius // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926f98
	float GetInAirSpawnTraceEndHeight(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceEndHeight // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927fbc
	struct AAIController* GetAIControllerClass(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetAIControllerClass // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927f2c
};
...
struct UFortAthenaAlertStateComponent : UActorComponent {
	...
	void SetStealthMeterTargetTime(float InStealthMeterTargetTime); // Function FortniteAI.FortAthenaAlertStateComponent.SetStealthMeterTargetTime // (Final|Native|Public|BlueprintCallable) // @ game+0x9928314
	void SetStealthMeterTarget(float InStealthMeterTarget); // Function FortniteAI.FortAthenaAlertStateComponent.SetStealthMeterTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x9928290
	void OnStealthMeterChanged(struct AFortAthenaAIBotController* BotController, float StealthMeterTarget, float StealthMeterTargetTime); // Function FortniteAI.FortAthenaAlertStateComponent.OnStealthMeterChanged // (Final|Native|Public) // @ game+0x9928194
	float GetStealthMeterTargetTime(); // Function FortniteAI.FortAthenaAlertStateComponent.GetStealthMeterTargetTime // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6a63a60
	float GetStealthMeterTarget(); // Function FortniteAI.FortAthenaAlertStateComponent.GetStealthMeterTarget // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x764352c
};
...
struct UFortAthenaBTService_ManageWeapon : UBTService {
	...
	void ManageWeaponTargeting(struct UBehaviorTreeComponent* OwnerComp); // Function FortniteAI.FortAthenaBTService_ManageWeapon.ManageWeaponTargeting // (Final|Native|Protected|Const) // @ game+0x99283c0
};
...
struct UFortAthenaBTService_Slide : UBTService {
	...
	void OnStopSliding(struct AFortPlayerPawn* Pawn); // Function FortniteAI.FortAthenaBTService_Slide.OnStopSliding // (Final|Native|Private) // @ game+0x99284e0
};
...
struct UFortAthenaLeashComponent : UActorComponent {
	...
	void SetLeashRadius(float NewRadius); // Function FortniteAI.FortAthenaLeashComponent.SetLeashRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x502c250
	bool IsInsideLeash(struct FVector& Location); // Function FortniteAI.FortAthenaLeashComponent.IsInsideLeash // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928fac
	float GetLeashRadius(); // Function FortniteAI.FortAthenaLeashComponent.GetLeashRadius // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928e0c
	struct FVector GetLeashCenter(); // Function FortniteAI.FortAthenaLeashComponent.GetLeashCenter // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928de4
};
...
struct AFortAthenaLocalGameplayBehavior : AActor {
	...
	void OnExecute(struct AActor* Activator); // Function FortniteAI.FortAthenaLocalGameplayBehavior.OnExecute // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnAbort(); // Function FortniteAI.FortAthenaLocalGameplayBehavior.OnAbort // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void FinishExecute(); // Function FortniteAI.FortAthenaLocalGameplayBehavior.FinishExecute // (Final|Native|Public|BlueprintCallable) // @ game+0x9928d4c
};
...
struct UFortAthenaNpcGalileoComponent : UActorComponent {
	...
	void SetPatrolPath(struct TArray<struct FVector>& NewPatrolPath); // Function FortniteAI.FortAthenaNpcGalileoComponent.SetPatrolPath // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99296dc
	void SetCommunicationGroup(struct TArray<struct AFortAthenaAIBotController*>& AIBotControllerList); // Function FortniteAI.FortAthenaNpcGalileoComponent.SetCommunicationGroup // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x992963c
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaNpcGalileoComponent.OnPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9929394
	struct TArray<struct FVector> GetPatrolPath(); // Function FortniteAI.FortAthenaNpcGalileoComponent.GetPatrolPath // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928e40
	struct TArray<struct AFortAthenaAIBotController*> GetCommunicationGroup(); // Function FortniteAI.FortAthenaNpcGalileoComponent.GetCommunicationGroup // (Final|Native|Public|BlueprintCallable) // @ game+0x9928da4
};
...
struct UFortAthenaNpcPatrollingComponent : UActorComponent {
	...
	void UpdateCurrentDestinationToNearestNextPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.UpdateCurrentDestinationToNearestNextPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x99298d4
	void SetPatrolPath(struct AFortAthenaPatrolPath* NewPatrolPath, bool bOrientationAlreadyRandomized); // Function FortniteAI.FortAthenaNpcPatrollingComponent.SetPatrolPath // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9929780
	void SelectNextPatrolPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.SelectNextPatrolPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x9929628
	bool IsPatrollingEnable(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.IsPatrollingEnable // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9929040
	bool IsCurrentPatrolPointAnEndPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.IsCurrentPatrolPointAnEndPoint // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928f68
	int32_t GetPatrolPointsCount(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetPatrolPointsCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928f40
	struct AFortAthenaPatrolPath* GetPatrolPath(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetPatrolPath // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7512e08
	struct AFortAthenaPatrolPoint* GetCurrentPatrolPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetCurrentPatrolPoint // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928dc0
	bool FindAndSetDynamicPatrolPath(struct FFortAthenaAIObjectTrackerQuery& FindQuery, bool bOrientationAlreadyRandomized, bool bExcludeCurrentlyUsedPatrolPath); // Function FortniteAI.FortAthenaNpcPatrollingComponent.FindAndSetDynamicPatrolPath // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9928c0c
};
...
struct AFortAthenaPatrolPath : AActor {
	...
	void SetPatrolPathEnabled(bool bIsEnabled); // Function FortniteAI.FortAthenaPatrolPath.SetPatrolPathEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x9929848
	void OnCurrentPlaylistLoaded(struct FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags); // Function FortniteAI.FortAthenaPatrolPath.OnCurrentPlaylistLoaded // (Final|Native|Protected|HasOutParms) // @ game+0x9929058
	void GetPatrolPoints(struct TArray<struct AFortAthenaPatrolPoint*>& OutPatrolPoints); // Function FortniteAI.FortAthenaPatrolPath.GetPatrolPoints // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928e5c
	bool CanBeUsed(); // Function FortniteAI.FortAthenaPatrolPath.CanBeUsed // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928be0
};
...
struct UFortAthenaTrackableAIObjectVehicleComponent : UFortAthenaTrackableAIObjectComponent {
	...
	void HandleSleepStateChanged(bool bIsAwake); // Function FortniteAI.FortAthenaTrackableAIObjectVehicleComponent.HandleSleepStateChanged // (Final|Native|Private) // @ game+0x9929adc
};
...
struct UFortBotMissionLogic : UObject {
	...
	struct AFortBotStructureBuilder* SpawnStructureBuilder(struct AActor* MissionGoal, struct UFortBuildingInstructions* BuildingInstructions); // Function FortniteAI.FortBotMissionLogic.SpawnStructureBuilder // (Final|Native|Public|BlueprintCallable) // @ game+0x992a220
	void SetGoalsInvulnerable(bool bGodMode); // Function FortniteAI.FortBotMissionLogic.SetGoalsInvulnerable // (Final|Native|Public|BlueprintCallable) // @ game+0x992a1a0
	void SetCurrentBehavior(struct UBehaviorTree* Behavior); // Function FortniteAI.FortBotMissionLogic.SetCurrentBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x992a120
	void ResetBehavior(); // Function FortniteAI.FortBotMissionLogic.ResetBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x992a028
	void OnMissionStarted(); // Function FortniteAI.FortBotMissionLogic.OnMissionStarted // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnMissionFinished(); // Function FortniteAI.FortBotMissionLogic.OnMissionFinished // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnMissionActivated(); // Function FortniteAI.FortBotMissionLogic.OnMissionActivated // (Event|Public|BlueprintEvent) // @ game+0xda071c
	bool OnInteractWithMissionGoal(struct AFortAIController* BotAI, struct AActor* MissionGoal); // Function FortniteAI.FortBotMissionLogic.OnInteractWithMissionGoal // (Event|Public|BlueprintEvent) // @ game+0xda071c
	bool OnCanStartOtherMission(struct AFortAIController* BotAI, struct AFortMission* OtherMission); // Function FortniteAI.FortBotMissionLogic.OnCanStartOtherMission // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnAssignedBehavior(struct AFortAIController* BotAI); // Function FortniteAI.FortBotMissionLogic.OnAssignedBehavior // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void MarkSingleLocator(struct AActor* LocatorActor); // Function FortniteAI.FortBotMissionLogic.MarkSingleLocator // (Final|Native|Public|BlueprintCallable) // @ game+0x9929ba8
	void MarkAllLocated(); // Function FortniteAI.FortBotMissionLogic.MarkAllLocated // (Final|Native|Public|BlueprintCallable) // @ game+0x9929b5c
	void ClearAllLocated(); // Function FortniteAI.FortBotMissionLogic.ClearAllLocated // (Final|Native|Public|BlueprintCallable) // @ game+0x9929aac
};
...
struct AFortBotStructureBuilder : AActor {
	...
	void RunDeconstructor(); // Function FortniteAI.FortBotStructureBuilder.RunDeconstructor // (Final|Native|Public|BlueprintCallable) // @ game+0x992a0a0
	void OnBuildingDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortBotStructureBuilder.OnBuildingDied // (Final|Native|Protected|HasDefaults) // @ game+0x9929dac
	void BuildAll(); // Function FortniteAI.FortBotStructureBuilder.BuildAll // (Final|Native|Public|BlueprintCallable) // @ game+0x9929a98
};
...
struct UFortCollisionResponseSwapperComponent : UActorComponent {
	...
	void UnregisterCallbacksForOverlap(); // Function FortniteAI.FortCollisionResponseSwapperComponent.UnregisterCallbacksForOverlap // (Final|Native|Protected|BlueprintCallable) // @ game+0x445afe8
	void RestoreCollisionResponses(); // Function FortniteAI.FortCollisionResponseSwapperComponent.RestoreCollisionResponses // (Final|Native|Protected) // @ game+0x992b0a0
	void RegisterCallbacksForOverlap(struct UPrimitiveComponent* InCollisionPrimitiveComponent, struct UPrimitiveComponent* InOverlapPrimitiveComponent); // Function FortniteAI.FortCollisionResponseSwapperComponent.RegisterCallbacksForOverlap // (Final|Native|Protected|BlueprintCallable) // @ game+0x445adc8
	void HandleEndOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function FortniteAI.FortCollisionResponseSwapperComponent.HandleEndOverlap // (Final|Native|Protected) // @ game+0x992a95c
	void HandleBeginOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult); // Function FortniteAI.FortCollisionResponseSwapperComponent.HandleBeginOverlap // (Final|Native|Protected|HasOutParms) // @ game+0x992a718
};
...
struct UFortCreativeCreatureManagerInfoComponent : UFortMinigameLogicComponent {
	...
	void SetWeaponKnockbackImmunityEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetWeaponKnockbackImmunityEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b9e8
	void SetWeaponKnockbackImmunity(bool InImmuneToWeaponKnockback); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable) // @ game+0x992b968
	void SetScorePoints(int32_t InScorePoints); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetScorePoints // (Final|Native|Public|BlueprintCallable) // @ game+0x992b8ec
	void SetScoreDistribution(enum class EScoreDistributionType InScoreDistribution); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetScoreDistribution // (Final|Native|Public|BlueprintCallable) // @ game+0x992b870
	void SetOverrideDamage(float InOverrideDamage); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetOverrideDamage // (Final|Native|Public|BlueprintCallable) // @ game+0x992b7ec
	void SetMovementSpeedOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementSpeedOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b76c
	void SetMovementSpeedMultiplier(float InOverrideMovementSpeedMultiplier); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable) // @ game+0x992b6e8
	void SetMovementOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x992b66c
	void SetMaxHealthOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealthOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x992b5f0
	void SetMaxHealthOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealthOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b570
	void SetMaxHealth(int32_t InMaxHealth); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealth // (Final|Native|Public|BlueprintCallable) // @ game+0x992b4f4
	void SetHearingAggroRange(float InHearingAggroRange); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetHearingAggroRange // (Final|Native|Public|BlueprintCallable) // @ game+0x992b470
	void SetEnvironmentalDamageOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetEnvironmentalDamageOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b3f0
	void SetEnvironmentalDamageOverride(float InOverrideDamage); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable) // @ game+0x992b36c
	void SetDamageOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetDamageOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x992b2f0
	void SetDamageOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetDamageOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b270
	void SetCreatureManagerComponent(struct UFortCreativeCreatureManagerComponent* InCreatureManagerComponent); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetCreatureManagerComponent // (Final|Native|Public|BlueprintCallable) // @ game+0x992b1f0
	void SetCreatureBlueprintClass(struct TSoftClassPtr<UObject> InCreatureBlueprintClass); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetCreatureBlueprintClass // (Final|Native|Public|BlueprintCallable) // @ game+0x992b130
	void SetAffectedTargetsType(enum class ECreatureManagerAffectedTargets InAffectedTargetsType); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetAffectedTargetsType // (Final|Native|Public|BlueprintCallable) // @ game+0x992b0b4
	void ResetWeaponKnockbackImmunity(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable) // @ game+0x992b088
	void ResetScorePoints(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetScorePoints // (Final|Native|Public|BlueprintCallable) // @ game+0x992b070
	void ResetScoreDistribution(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetScoreDistribution // (Final|Native|Public|BlueprintCallable) // @ game+0x992b058
	void ResetOverrideDamage(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetOverrideDamage // (Final|Native|Public|BlueprintCallable) // @ game+0x992b040
	void ResetMovementSpeedMultiplier(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable) // @ game+0x992b028
	void ResetMaxHealth(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetMaxHealth // (Final|Native|Public|BlueprintCallable) // @ game+0x992b010
	void ResetHearingAggroRange(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetHearingAggroRange // (Final|Native|Public|BlueprintCallable) // @ game+0x992aff8
	void ResetEnvironmentalDamageOverride(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable) // @ game+0x992afe0
	bool GetWeaponKnockbackImmunity(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a700
	int32_t GetScorePoints(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetScorePoints // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x743610c
	enum class EScoreDistributionType GetScoreDistribution(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetScoreDistribution // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a6e8
	float GetOverrideDamage(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetOverrideDamage // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a6d0
	float GetMovementSpeedMultiplier(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a6b8
	int32_t GetMaxHealth(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetMaxHealth // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x24d8c28
	float GetHearingAggroRange(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetHearingAggroRange // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x74360f4
	float GetEnvironmentalDamageOverride(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a6a0
	struct UFortCreativeCreatureManagerComponent* GetCreatureManagerComponent(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetCreatureManagerComponent // (Final|Native|Public|BlueprintCallable) // @ game+0x992a688
	struct TSoftClassPtr<UObject> GetCreatureBlueprintClass(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetCreatureBlueprintClass // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a554
	enum class ECreatureManagerAffectedTargets GetAffectedTargetsType(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetAffectedTargetsType // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a53c
};
...
struct UFortCreativeCreatureManagerComponent : UActorComponent {
	...
	void OnInfoComponentRemoved(struct UFortCreativeCreatureManagerInfoComponent* CreatureManagerInfoComponent); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnInfoComponentRemoved // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992af44
	void OnInfoComponentAdded(struct UFortCreativeCreatureManagerInfoComponent* CreatureManagerInfoComponent); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnInfoComponentAdded // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992ae98
	void OnAIPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnAIPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x992aa98
};
...
struct AFortCreativePatrolPath : AFortAthenaPatrolPath {
	...
	void SetPatrolHasValidNavMesh(bool bValidNavMesh); // Function FortniteAI.FortCreativePatrolPath.SetPatrolHasValidNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x502ced0
	bool HasPatrolValidNavMesh(); // Function FortniteAI.FortCreativePatrolPath.HasPatrolValidNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x502ceb0
};
...
struct UFortEnvQueryManager : UEnvQueryManager {
	...
	void OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.FortEnvQueryManager.OnGamePhaseChanged // (Final|Native|Protected) // @ game+0x992c174
};
...
struct AFortEQSPrevisActor : AActor {
	...
	void SetQueryTemplate(struct UEnvQuery* InPrevisQueryTemplate); // Function FortniteAI.FortEQSPrevisActor.SetQueryTemplate // (Final|Native|Public|BlueprintCallable) // @ game+0x651d978
	void PrepForPrevis(); // Function FortniteAI.FortEQSPrevisActor.PrepForPrevis // (Event|Public|BlueprintEvent) // @ game+0xda071c
};
...
struct UFortInfluenceMap : UObject {
	...
	void K2_GetInfluenceSourcePositions(struct UObject* WorldContext, struct TArray<struct FVector>& InfluenceSourcePositions); // Function FortniteAI.FortInfluenceMap.K2_GetInfluenceSourcePositions // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x992c074
	void K2_AddInfluenceSource(struct UObject* WorldContext, struct FVector& Position, struct FString SourceName, float Strength); // Function FortniteAI.FortInfluenceMap.K2_AddInfluenceSource // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x992be60
};
...
struct UFortNavPathRendererComponent : UActorComponent {
	...
	void UpdatePathsVisualOnClient(); // Function FortniteAI.FortNavPathRendererComponent.UpdatePathsVisualOnClient // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992d4b8
	void OnRep_PathPointsUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_PathPointsUpdated // (Final|Native|Private) // @ game+0x992ced8
	void OnRep_ColorIndexUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_ColorIndexUpdated // (Final|Native|Private) // @ game+0x992cec4
	void DeactivateFX(); // Function FortniteAI.FortNavPathRendererComponent.DeactivateFX // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992c920
};
...
struct UFortPatrolWardInterface : UInterface {
	...
	enum class EWardAffectType GetAffectingType(); // Function FortniteAI.FortPatrolWardInterface.GetAffectingType // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent|Const) // @ game+0xda071c
	float GetAffectingDistance(); // Function FortniteAI.FortPatrolWardInterface.GetAffectingDistance // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent|Const) // @ game+0xda071c
};
...
struct UFortPawnComponent_AIBotPingCommand : UFortPawnComponent_PingCommand {
	...
	void OnServerMarkerRemoved(struct FMarkerID MarkerID); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.OnServerMarkerRemoved // (Final|Native|Public) // @ game+0x992cf90
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.OnServerMarkerAdded // (Final|Native|Public|HasOutParms) // @ game+0x992ceec
	void HandleOnNPCUnconvertEvent(struct AFortPawn* UnconvertedFortPawn, enum class EUnconvertReason UnconvertReason); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.HandleOnNPCUnconvertEvent // (Final|Native|Public) // @ game+0x992c998
};
...
struct UFortPawnComponent_AIFormation : UFortPawnComponent {
	...
	void OnUserDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortPawnComponent_AIFormation.OnUserDied // (Final|Native|Private|HasDefaults) // @ game+0x992d0e0
};
...
struct UFortPawnComponent_AIGroup : UFortPawnComponent {
	...
	void OnGroupMemberDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortPawnComponent_AIGroup.OnGroupMemberDied // (Final|Native|Private|HasDefaults) // @ game+0x992cb68
};
...
struct UFortQueryTwoPointSolver : UObject {
	...
	void Start(struct UObject* Querier); // Function FortniteAI.FortQueryTwoPointSolver.Start // (Final|Native|Public|BlueprintCallable) // @ game+0x992db98
	void SkipToNextPointA(); // Function FortniteAI.FortQueryTwoPointSolver.SkipToNextPointA // (Final|Native|Public|BlueprintCallable) // @ game+0x992db80
	void SetCustomRotationA(struct FRotator& Rotation); // Function FortniteAI.FortQueryTwoPointSolver.SetCustomRotationA // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x992dae8
	void OnCustomRotationMode(struct FVector& InPointA, struct FVector Querier); // Function FortniteAI.FortQueryTwoPointSolver.OnCustomRotationMode // (Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda071c
	struct FRotator GetRandomRotationOffset(); // Function FortniteAI.FortQueryTwoPointSolver.GetRandomRotationOffset // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x992dab0
	void AddNamedFloatParamB(struct FName ParamName, float Value); // Function FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamB // (Final|Native|Public|BlueprintCallable) // @ game+0x992d9b4
	void AddNamedFloatParamA(struct FName ParamName, float Value); // Function FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamA // (Final|Native|Public|BlueprintCallable) // @ game+0x992d8b8
};
...
struct AFortThreatVisualsManager : AActor {
	...
	bool StormsExist(); // Function FortniteAI.FortThreatVisualsManager.StormsExist // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x993ed64
	void SetMinimumCloudAltitude(float NewMinimumAltitude); // Function FortniteAI.FortThreatVisualsManager.SetMinimumCloudAltitude // (Final|Native|Public|BlueprintCallable) // @ game+0x929eb0c
	void SetCloudsAreHidden(bool bHide); // Function FortniteAI.FortThreatVisualsManager.SetCloudsAreHidden // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x993eccc
	void ResetMinimumCloudAltitude(); // Function FortniteAI.FortThreatVisualsManager.ResetMinimumCloudAltitude // (Final|Native|Public|BlueprintCallable) // @ game+0x993ecb4
	void OnWorldReady(); // Function FortniteAI.FortThreatVisualsManager.OnWorldReady // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void OnThreatCloudsChanged(struct TArray<struct FThreatLocationInfo>& ThreatLocationInfo); // Function FortniteAI.FortThreatVisualsManager.OnThreatCloudsChanged // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda071c
	void OnRep_ThreatLocations(); // Function FortniteAI.FortThreatVisualsManager.OnRep_ThreatLocations // (Final|Native|Private) // @ game+0x16d0580
	void OnRep_StormWinds(); // Function FortniteAI.FortThreatVisualsManager.OnRep_StormWinds // (Final|Native|Private) // @ game+0x2134330
	void OnRep_HideClouds(); // Function FortniteAI.FortThreatVisualsManager.OnRep_HideClouds // (Final|Native|Private) // @ game+0x1652184
	void OnRep_GoalActorLocations(); // Function FortniteAI.FortThreatVisualsManager.OnRep_GoalActorLocations // (Final|Native|Private) // @ game+0x165205c
	void OnBeginThreatVisualsPrecursor(struct AActor* SourceActor, struct FVector& EndLocation); // Function FortniteAI.FortThreatVisualsManager.OnBeginThreatVisualsPrecursor // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda071c
	struct TArray<struct FThreatLocationInfo> GetThreatClouds(); // Function FortniteAI.FortThreatVisualsManager.GetThreatClouds // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x993ec20
	struct AThreatCloud* GetThreatCloud(struct FThreatLocationInfo& ThreatLocInfo); // Function FortniteAI.FortThreatVisualsManager.GetThreatCloud // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x993eb2c
	bool GetCloudsAreHidden(); // Function FortniteAI.FortThreatVisualsManager.GetCloudsAreHidden // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x993eb14
	void BeginThreatVisualsPrecursor(struct AActor* SourceActor, struct FVector ThreatLocation); // Function FortniteAI.FortThreatVisualsManager.BeginThreatVisualsPrecursor // (Net|NetReliableNative|Event|NetMulticast|Public|HasDefaults) // @ game+0x993ea38
};
...
struct AThreatCloud : AActor {
	...
	void OnThreatVolumeChanged(); // Function FortniteAI.ThreatCloud.OnThreatVolumeChanged // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnLightningStrike(struct FVector& StartLocation, struct FVector& EndLocation, struct ABuildingRift* Rift, bool bLightningStruckRift); // Function FortniteAI.ThreatCloud.OnLightningStrike // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda071c
	void OnCloudStart(); // Function FortniteAI.ThreatCloud.OnCloudStart // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnCloudHiddenChange(bool bCloudsAreHidden); // Function FortniteAI.ThreatCloud.OnCloudHiddenChange // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnCloudDeactivated(enum class EFortThreatDeactivationType DeactivationType); // Function FortniteAI.ThreatCloud.OnCloudDeactivated // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnCloudActivated(); // Function FortniteAI.ThreatCloud.OnCloudActivated // (Event|Public|BlueprintEvent) // @ game+0xda071c
	void OnBeginDeath(); // Function FortniteAI.ThreatCloud.OnBeginDeath // (Event|Protected|BlueprintEvent) // @ game+0xda071c
	void ManualLightningFlash(); // Function FortniteAI.ThreatCloud.ManualLightningFlash // (RequiredAPI|Event|Public|BlueprintEvent) // @ game+0xda071c
	struct FBox GetThreatVolume(); // Function FortniteAI.ThreatCloud.GetThreatVolume // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x993ec74
};
