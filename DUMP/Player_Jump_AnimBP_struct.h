...
struct FAnimBlueprintGeneratedConstantData : FAnimBlueprintConstantData {
	...
	int32_t ; // 0x144(0x04)
	enum class ERefPoseType ; // 0x148(0x01)
	...
	enum class EAlphaBlendOption ; // 0x178(0x01)
	enum class EBlendListTransitionType ; // 0x179(0x01)
	...
	int32_t ; // 0x1a4(0x04)
	float ; // 0x1a8(0x04)
	struct FInputScaleBiasClampConstants ; // 0x1ac(0x2c)
	float ; // 0x1d8(0x04)
	char pad_1DC[0x4]; // 0x1dc(0x04)
	struct UAnimSequenceBase* ; // 0x1e0(0x08)
	bool ; // 0x1e8(0x01)
	enum class EAnimSyncMethod ; // 0x1e9(0x01)
	enum class EAnimGroupRole ; // 0x1ea(0x01)
	char pad_1EB[0x1]; // 0x1eb(0x01)
	struct FName ; // 0x1ec(0x04)
	struct FName ; // 0x1f0(0x04)
	int32_t ; // 0x1f4(0x04)
	struct FAnimNodeFunctionRef ; // 0x1f8(0x18)
