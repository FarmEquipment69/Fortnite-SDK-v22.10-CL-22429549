...
struct UFortAIFaunaAnimInstance : UFortAIAnimInstance {
	...
	void UpdateTurnAngleStored(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateTurnAngleStored // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0690
	void UpdateSwimmingYaw(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateSwimmingYaw // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0678
	void UpdateRidingMovePlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateRidingMovePlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b05a4
	void UpdatePlayLandAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdatePlayLandAdditive // (Native|Event|Public|BlueprintEvent) // @ game+0x65b058c
	void UpdateFootPhaseStop(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateFootPhaseStop // (Native|Event|Public|BlueprintEvent) // @ game+0x60eb714
	void UpdateBoostPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBoostPlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b03ec
	void UpdateBodyRoll(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBodyRoll // (Native|Event|Public|BlueprintEvent) // @ game+0x65b03d4
	void UpdateBackwardVelocity(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBackwardVelocity // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0378
	void UpdateBackwardsPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBackwardsPlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0390
	void FinishFootPhaseStopUpdate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.FinishFootPhaseStopUpdate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0360
	void CalculateLookAtAlpha(bool bForceDisableLookAt, float DeltaSeconds); // Function IrwinRuntime.FortAIFaunaAnimInstance.CalculateLookAtAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0164
};
...
struct UFortAIFaunaAnimInstance_Grandma : UFortAIFaunaAnimInstance {
	...
	void UpdateStateVariables(bool bAccelerating); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateStateVariables // (Final|Native|Public|BlueprintCallable) // @ game+0x65b05e4
	void UpdateShouldPlayFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateShouldPlayFullBodyInPlace // (Final|Native|Public|BlueprintCallable) // @ game+0x65b05bc
	void UpdateMovingRates(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMovingRates // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0564
	void UpdateMeshScale(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMeshScale // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0540
	void UpdateLocomotionPoseAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateLocomotionPoseAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0514
	void UpdateIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateIdleStartTurn // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0470
	void UpdateEnableSniffAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableSniffAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65b044c
	void UpdateEnableAlertAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableAlertAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0404
	void UpdateBlinkAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateBlinkAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b03a8
	bool DetermineShouldPlayFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineShouldPlayFullBodyInPlace // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b033c
	bool DetermineIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineIdleStartTurn // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b02d0
	bool DetermineEnableSniffAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableSniffAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b02b0
	bool DetermineEnableAlertAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableAlertAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0270
	float CalculateWalkRunPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateWalkRunPlayRate // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b024c
	float CalculateMeshScale(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateMeshScale // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b022c
	float CalculateLocomotionPoseAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateLocomotionPoseAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b013c
	float CalculateBlinkAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateBlinkAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b00ec
};
...
struct UFortAIFaunaAnimInstance_Robert : UFortAIFaunaAnimInstance {
	...
	void UpdateStateVariables(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateStateVariables // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0664
	void UpdateLocomotionPoseAdditiveAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateLocomotionPoseAdditiveAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b04e8
	void UpdateIsFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateIsFullBodyInPlace // (Final|Native|Public|BlueprintCallable) // @ game+0x65b04c0
	void UpdateIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateIdleStartTurn // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0498
	void UpdateEnableHeadTiltDownAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateEnableHeadTiltDownAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0428
	bool DetermineIsFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineIsFullBodyInPlace // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0318
	bool DetermineIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineIdleStartTurn // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b02f4
	bool DetermineEnableHeadTiltDownAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineEnableHeadTiltDownAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0290
	float CalculateLocomotionPoseAdditiveAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.CalculateLocomotionPoseAdditiveAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0114
};
