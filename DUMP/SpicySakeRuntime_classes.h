...
struct UFortSpicySakeOccupantAnimInstanceLayer : UFortBaseLayerAnimInstance {
	float GroundIdleThreshold; // 0x438(0x04)
	float GroundIdleLowThreshold; // 0x43c(0x04)
	float LocalVelocityYawAngleTurnResetThreshold; // 0x440(0x04)
	float LocalVelocityYawAngleTurnTransitionThreshold; // 0x444(0x04)
	float LocalVelocityYawAngle; // 0x448(0x04)
	float PawnSpeed2D; // 0x44c(0x04)
	float PawnVelocityZ; // 0x450(0x04)
	char bIsFemale : 1; // 0x454(0x01)
	char bIsOnGround : 1; // 0x454(0x01)
	char bIsOnWater : 1; // 0x454(0x01)
	char bLandingPredicted : 1; // 0x454(0x01)
	char bTransition_NewFallAditive_NewFallLandAdditive : 1; // 0x454(0x01)
	char bTransitionNewJumpLoopAdditiveToNewFallAdditive : 1; // 0x454(0x01)
	char bShouldApplyIdleAdditive : 1; // 0x454(0x01)
	char bIsTargeting : 1; // 0x454(0x01)
	char bIsPlayerCloseToShark : 1; // 0x455(0x01)
	char bIsBoosting : 1; // 0x455(0x01)
	char bCanTurnLeft : 1; // 0x455(0x01)
	char bCanTurnRight : 1; // 0x455(0x01)
	char bTransition_RideLoop_TurnLeft : 1; // 0x455(0x01)
	char bTransition_RideLoop_TurnRight : 1; // 0x455(0x01)
	char bIsReloading : 1; // 0x455(0x01)
	char bIsPlayingMeleeAnim : 1; // 0x455(0x01)
	char bIsPlayingEmote : 1; // 0x456(0x01)
	char bShouldPlayOnGroundIdle : 1; // 0x456(0x01)
	char bShouldPlayOnGroundIdleLow : 1; // 0x456(0x01)
	char bIsJumping : 1; // 0x456(0x01)
	char bCanUseTargettingStateMachine : 1; // 0x456(0x01)
	char bTransition_SharRideLoop_To_JumpUp : 1; // 0x456(0x01)
