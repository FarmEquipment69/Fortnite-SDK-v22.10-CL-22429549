...
struct UFortCheatManager_RockVehicle : UChildCheatManager {
	...
	void RockVehicleSetVelocity(float X, float Y, float Z); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetVelocity // (Final|Exec|Native|Public) // @ game+0x4c8c3f0
	void RockVehicleSetRotation(float Pitch, float Yaw, float Roll); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetRotation // (Final|Exec|Native|Public) // @ game+0x4c8c3f0
	void RockVehicleSetLocation(float X, float Y, float Z); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetLocation // (Final|Exec|Native|Public) // @ game+0x4c8c3f0
	void RockVehicleSetBalboaVelocity(float X, float Y, float Z); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetBalboaVelocity // (Final|Exec|Native|Public) // @ game+0x4c8c3f0
};
...
struct ARockVehicle : AFortAthenaSKVehicle {
	...
	void ServerSetLegacyDamageValues(bool bDamageFriendlyVehicles, bool bDamageOtherVehicles, bool bDamageOwnVehicle, bool bDamageAllowedFromOtherVehicle); // Function RockVehicleRuntime.RockVehicle.ServerSetLegacyDamageValues // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x4c8c520
	void RockFreeCamToggledDelegate__DelegateSignature(bool bFreeCam); // DelegateFunction RockVehicleRuntime.RockVehicle.RockFreeCamToggledDelegate__DelegateSignature // (MulticastDelegate|Public|Delegate) // @ game+0xda071c
	void OnSpringImpact__DelegateSignature(struct FName Socket, float ImpactSpeed, struct FHitResult& OutHit); // DelegateFunction RockVehicleRuntime.RockVehicle.OnSpringImpact__DelegateSignature // (MulticastDelegate|Public|Delegate|HasOutParms) // @ game+0xda071c
	float GetThrottleState(); // Function RockVehicleRuntime.RockVehicle.GetThrottleState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c0e0
	struct FFortAthenaVehicleInputState GetDriverInput(); // Function RockVehicleRuntime.RockVehicle.GetDriverInput // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c000
	struct FRockRuntimeConfigOverrides GetCurrentRockRuntimeConfigOverrides(); // Function RockVehicleRuntime.RockVehicle.GetCurrentRockRuntimeConfigOverrides // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8bfe0
};
...
struct URockVehicleAbility : UActorComponent {
	...
	struct ARockVehicle* GetVehicle(); // Function RockVehicleRuntime.RockVehicleAbility.GetVehicle // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c120
	float GetInactiveSeconds(); // Function RockVehicleRuntime.RockVehicleAbility.GetInactiveSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c060
	float GetActiveSeconds(); // Function RockVehicleRuntime.RockVehicleAbility.GetActiveSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8bfc0
};
...
struct URockVehicleBoostTank : UActorComponent {
	...
	void OnRep_SecondsRemaining(float PrevValue); // Function RockVehicleRuntime.RockVehicleBoostTank.OnRep_SecondsRemaining // (Final|Native|Protected) // @ game+0x4c8c250
	bool IsBoostFull(); // Function RockVehicleRuntime.RockVehicleBoostTank.IsBoostFull // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c210
	bool HasBoost(); // Function RockVehicleRuntime.RockVehicleBoostTank.HasBoost // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c1e0
	void GiveBoost(float Seconds); // Function RockVehicleRuntime.RockVehicleBoostTank.GiveBoost // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x4c8c140
	float GetPercentRemaining(); // Function RockVehicleRuntime.RockVehicleBoostTank.GetPercentRemaining // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c0b0
	float GetMaxBoostInSeconds(); // Function RockVehicleRuntime.RockVehicleBoostTank.GetMaxBoostInSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8c090
};
...
struct URockVehicleAbility_GroundTrails : URockVehicleAbility {
	...
	void OnSurfaceChanged(enum class EPhysicalSurface NewSurface); // Function RockVehicleRuntime.RockVehicleAbility_GroundTrails.OnSurfaceChanged // (Final|Native|Protected|BlueprintCallable) // @ game+0x4c8c300
};
...
struct ARockVehicleAudioController : AFortVehicleAudioController {
	...
	void SetSurfaceTypeParam(float NewSurfaceParam); // Function RockVehicleRuntime.RockVehicleAudioController.SetSurfaceTypeParam // (Final|Native|Public|BlueprintCallable) // @ game+0x4ca1040
	void SetBoosting(bool bNewBoosting); // Function RockVehicleRuntime.RockVehicleAudioController.SetBoosting // (Final|Native|Public|BlueprintCallable) // @ game+0x4ca0fa0
	void OnInAirUpdated(bool bNewInAir); // Function RockVehicleRuntime.RockVehicleAudioController.OnInAirUpdated // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda071c
	struct UAudioMotorModelComponent* GetMotorSimComponent(); // Function RockVehicleRuntime.RockVehicleAudioController.GetMotorSimComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4ca0f80
};
...
struct UStreamingRadioPlayerComponent_Rock : UStreamingRadioPlayerComponent {
	...
	void VehicleExploded(struct AController* LastDamageInstigator, struct AFortAthenaVehicle* Vehicle); // Function RockVehicleRuntime.StreamingRadioPlayerComponent_Rock.VehicleExploded // (Final|Native|Protected) // @ game+0x4ca10e0
};
