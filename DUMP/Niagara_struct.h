...
struct FNiagaraSimCacheCreateParameters {
	char bAllowRebasing : 1; // 0x00(0x01)
	char bAllowDataInterfaceCaching : 1; // 0x00(0x01)
	char pad_0_2 : 6; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TArray<struct FName> RebaseIncludeList; // 0x08(0x10)
	struct TArray<struct FName> RebaseExcludeList; // 0x18(0x10)
};
